...
Definition Iff_Relation_Class : Relation_Class.
  ...
  red; intros; apply iff_sym; trivial.
  red; intros; apply iff_refl.
Defined.
...
Add Relation Prop iff
  reflexivity proved by (fun x => @iff_refl x)
  symmetry proved by (fun x y H => @iff_sym x y H)
  transitivity proved by (fun x y z => @iff_trans x y z)
as iff_relation.
