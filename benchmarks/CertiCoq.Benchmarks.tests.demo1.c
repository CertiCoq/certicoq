#ifndef CERTICOQ_BENCHMARKS_TESTS_DEMO1_C
#define CERTICOQ_BENCHMARKS_TESTS_DEMO1_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Benchmarks.tests.demo1.h"
extern struct thread_info *make_tinfo(void);
extern value app_uncurried_102(struct thread_info *, value, value);
extern value repeat_uncurried_101(struct thread_info *, value, value);
extern value body(struct thread_info *);
value app_uncurried_102(struct thread_info *, value, value);
...
unsigned long long const repeat_uncurried_info_136[4] = { 0LL, 2LL, 0LL, 1LL,
  };

unsigned long long const app_uncurried_info_135[4] = { 0LL, 2LL, 0LL, 1LL, };

value app_uncurried_102(struct thread_info *$tinfo, value $m_111, value $l_112)
{
    ...
    switch (*((value *) $l_112 + -1LL) & 255LL) {
      default:
        ...
        *(root + 0LL) = $a_113;
        ...
        (*$tinfo).fp = &frame;
        $y_115 =
          ((value (*)(struct thread_info *, value, value)) app_uncurried_102)
          ($tinfo, $m_111, $l1_114);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        if (!(3LL <= $limit - $alloc)) {
...
value repeat_uncurried_101(struct thread_info *$tinfo, value $n_104, value $x_105)
{
  struct stack_frame frame;
  value root[2];
...
#endif /* CERTICOQ_BENCHMARKS_TESTS_DEMO1_C */
