...
let compare_constr_int f t1 t2 =
  match kind_of_term t1, kind_of_term t2 with
    ...
    | Prod (_,imp1,t1,c1), Prod (_,imp2,t2,c2) 
    | Lambda (_,imp1,t1,c1), Lambda (_,imp2,t2,c2) when imp1=imp2 ->
	(f =? f) t1 t2 c1 c2 
    | LetIn (_,imp1,b1,t1,c1), LetIn (_,imp2,b2,t2,c2) when imp1=imp2 -> 
	((f =? f) ==? f) b1 b2 t1 t2 c1 c2
    | App (_,_,_), App (_,_,_) ->
	let c1,l1,imps1=decompose_app t1 
	and c2,l2,imps2=decompose_app t2 in
