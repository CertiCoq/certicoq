...
let test2_L5 =
  Ret
    (((('C'::('o'::('q'::('.'::('I'::('n'::('i'::('t'::('.'::('D'::('a'::('t'::('a'::('t'::('y'::('p'::('e'::('s'::('.'::('b'::('o'::('o'::('l'::[]))))))))))))))))))))))),
    ({ itypNm = ('b'::('o'::('o'::('l'::[])))); itypCnstrs = ({ cnstrNm =
    ('t'::('r'::('u'::('e'::[])))); cnstrArity = 0 } :: ({ cnstrNm =
    ('f'::('a'::('l'::('s'::('e'::[]))))); cnstrArity =
    0 } :: [])) } :: [])) :: ((('C'::('o'::('q'::('.'::('I'::('n'::('i'::('t'::('.'::('D'::('a'::('t'::('a'::('t'::('y'::('p'::('e'::('s'::('.'::('u'::('n'::('i'::('t'::[]))))))))))))))))))))))),
    ({ itypNm = ('u'::('n'::('i'::('t'::[])))); itypCnstrs = ({ cnstrNm =
    ('t'::('t'::[])); cnstrArity =
    0 } :: []) } :: [])) :: ((('C'::('o'::('q'::('.'::('I'::('n'::('i'::('t'::('.'::('D'::('a'::('t'::('a'::('t'::('y'::('p'::('e'::('s'::('.'::('n'::('a'::('t'::[])))))))))))))))))))))),
    ...
    ('C'::('e'::('r'::('t'::('i'::('C'::('o'::('q'::('.'::('C'::('o'::('m'::('p'::('i'::('l'::('e'::('r'::('.'::('a'::('l'::('l'::('I'::('n'::('s'::('t'::('a'::('n'::('c'::('e'::('s'::('#'::('T'::('E'::('S'::('T'::('_'::('L'::('6'::('#'::('e'::('v'::('e'::('n'::[]))))))))))))))))))))))))))))))))))))))))))))) :: ((((fun p->1+2*p)
    1), (NNamed ('k'::[]))) :: [])), (Oterm (CRet, ((Bterm ([], (Oterm
    (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []),
    (Oterm (CRet, ((Bterm ([], (Vterm (((fun p->1+2*p) 1), (NNamed
    ('k'::[])))))) :: ((Bterm ([], (Vterm (((fun p->2*p) 1), (NNamed
    ('C'::('e'::('r'::('t'::('i'::('C'::('o'::('q'::('.'::('C'::('o'::('m'::('p'::('i'::('l'::('e'::('r'::('.'::('a'::('l'::('l'::('I'::('n'::('s'::('t'::('a'::('n'::('c'::('e'::('s'::('#'::('T'::('E'::('S'::('T'::('_'::('L'::('6'::('#'::('e'::('v'::('e'::('n'::[])))))))))))))))))))))))))))))))))))))))))))))))) :: [])))))) :: []))))) :: ((Bterm
    ...
    ((Pervasives.succ (Pervasives.succ 0)), 0)), ((Bterm (((((fun p->2*p) 1),
    (NNamed ('e'::('v'::('e'::('n'::[])))))) :: ((((fun p->2*p) ((fun p->2*p)
    1)), (NNamed ('o'::('d'::('d'::[]))))) :: [])), (Oterm (CLambda, ((Bterm
    (((((fun p->2*p) ((fun p->1+2*p) 1)), (NNamed
    ('x'::[]))) :: ((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: [])), (Oterm
    (CRet, ((Bterm ([], (Oterm (CKLambda, ((Bterm (((((fun p->1+2*p) 1),
    (NNamed ('k'::[]))) :: []), (Oterm (CRet, ((Bterm ([], (Vterm
    (((fun p->1+2*p) 1), (NNamed ('k'::[])))))) :: ((Bterm ([], (Oterm
    (CLambda, ((Bterm (((((fun p->2*p) ((fun p->2*p) ((fun p->2*p) 1))),
    (NNamed ('y'::[]))) :: ((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: [])),
    (Oterm (CRet, ((Bterm ([], (Oterm (CKLambda, ((Bterm (((((fun p->1+2*p)
    1), (NNamed ('k'::[]))) :: []), (Oterm (CRet, ((Bterm ([], (Oterm
    (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []),
    (Oterm (CRet, ((Bterm ([], (Vterm (((fun p->1+2*p) 1), (NNamed
    ('k'::[])))))) :: ((Bterm ([], (Vterm (((fun p->2*p) ((fun p->1+2*p) 1)),
    (NNamed ('x'::[])))))) :: [])))))) :: []))))) :: ((Bterm ([], (Oterm
    ...
    ([], (Vterm (((fun p->1+2*p) 1), (NNamed
    ('k'::[])))))) :: [])))))) :: ((Bterm (((((fun p->2*p) ((fun p->1+2*p)
    ((fun p->2*p) 1))), NAnon) :: []), (Oterm (CRet, ((Bterm ([], (Oterm
    (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []),
    (Oterm (CRet, ((Bterm ([], (Oterm (CKLambda, ((Bterm (((((fun p->1+2*p)
    1), (NNamed ('k'::[]))) :: []), (Oterm (CRet, ((Bterm ([], (Vterm
    (((fun p->1+2*p) 1), (NNamed ('k'::[])))))) :: ((Bterm ([], (Oterm
    (CLambda, ((Bterm (((((fun p->2*p) ((fun p->2*p) ((fun p->1+2*p) 1))),
    (NNamed ('x'::('\''::[])))) :: ((((fun p->1+2*p) 1), (NNamed
...
let out2 =
  compL6_and_print_twice test2_L5
