...
Lemma lookup_eval_env:
  forall (e : environ LambdaBoxMut.compile.Term) prims,
    crctEnv e ->
...
Lemma crctTerm_exp_wf_ind (prims : list (Pipeline_utils.primitive * positive)) (H : prims = []) :
...
Lemma crctTerm_exp_wf_ind' prims (H : prims = []) :
  (forall e n t, crctTerm e n t ->
...
Theorem translate_correct prims (Heq : prims = []) (e : environ Term) (t t' : Term) :
  crctEnv e -> crctTerm e 0 t ->
