#ifndef CERTICOQ_TESTS_TESTS_LIST_SUM_OPT2_C
#define CERTICOQ_TESTS_TESTS_LIST_SUM_OPT2_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Tests.tests.list_sum_opt2.h"
...
unsigned long long const body_info_229[2] = { 202LL, 0LL, };

unsigned long long const repeat_uncurried_known_info_228[4] = { 0LL, 2LL,
  0LL, 1LL, };

unsigned long long const fold_left_uncurried_known_info_227[4] = { 0LL, 2LL,
  0LL, 1LL, };

unsigned long long const add_uncurried_known_info_226[4] = { 0LL, 2LL, 0LL,
  1LL, };

value add_uncurried_known_103(struct thread_info *$tinfo, value $m_115, value $n_116)
{
  struct stack_frame frame;
  value root[2];
  register value $p_117;
  ...
  frame.prev = (*$tinfo).fp;
  if (($n_116 & 1) == 0) {
    switch (*((value *) $n_116 + -1LL) & 255LL) {
      default:
        $p_117 = *((value *) $n_116 + 0LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        /*skip*/;
...
value fold_left_uncurried_known_102(struct thread_info *$tinfo, value $a0_110, value $l_111)
{
  struct stack_frame frame;
  value root[2];
  register value $b_112;
  register value $t_113;
  ...
  frame.prev = (*$tinfo).fp;
  if (($l_111 & 1) == 0) {
    switch (*((value *) $l_111 + -1LL) & 255LL) {
      default:
        $b_112 = *((value *) $l_111 + 0LL);
        $t_113 = *((value *) $l_111 + 1LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 0LL) = $t_113;
...
value body(struct thread_info *$tinfo)
{
  ...
  register value $CertiCoqdTestsdtestsdlist_sum_225;
  register value *$alloc;
  register value *$limit;
  register value *$args;
  $alloc = (*$tinfo).alloc;
  ...
  *((value *) $y_222 + 0LL) = $y_221;
  ...
  (*$tinfo).limit = $limit;
  /*skip*/;
  $CertiCoqdTestsdtestsdlist_sum_225 =
    ((value (*)(struct thread_info *, value, value)) fold_left_uncurried_known_102)
    ($tinfo, $y_224, $y_223);
  $alloc = (*$tinfo).alloc;
  $limit = (*$tinfo).limit;
  ...
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  return $CertiCoqdTestsdtestsdlist_sum_225;
}


#endif /* CERTICOQ_TESTS_TESTS_LIST_SUM_OPT2_C */
