...
val register : prim list -> (string * bool) list -> unit
...
module CompileFunctor (CI : CompilerInterface) : sig
  val compile_only : options -> Names.GlobRef.t -> (string * bool) list -> unit
  val generate_glue_only : options -> Names.GlobRef.t -> unit
  val compile_C : options -> Names.GlobRef.t -> (string * bool) list -> unit
