#ifndef CERTICOQ_TESTS_TESTS_REC_CLOS_OPT1_C
#define CERTICOQ_TESTS_TESTS_REC_CLOS_OPT1_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Tests.tests.rec_clos_opt1.h"
extern struct thread_info *make_tinfo(void);
extern value aux_104(struct thread_info *, value, value);
extern value repeat_uncurried_known_103(struct thread_info *, value, value);
extern value mul_uncurried_known_102(struct thread_info *, value, value);
extern value add_uncurried_known_101(struct thread_info *, value, value);
extern value body(struct thread_info *);
value aux_104(struct thread_info *, value, value);
value repeat_uncurried_known_103(struct thread_info *, value, value);
value mul_uncurried_known_102(struct thread_info *, value, value);
value add_uncurried_known_101(struct thread_info *, value, value);
value body(struct thread_info *);
unsigned long long const body_info_763[2] = { 1212LL, 0LL, };

unsigned long long const add_uncurried_known_info_762[4] = { 0LL, 2LL, 0LL,
  1LL, };

unsigned long long const mul_uncurried_known_info_761[4] = { 0LL, 2LL, 0LL,
  1LL, };

unsigned long long const repeat_uncurried_known_info_760[4] = { 0LL, 2LL,
  0LL, 1LL, };

unsigned long long const aux_info_759[4] = { 0LL, 2LL, 0LL, 1LL, };

value aux_104(struct thread_info *$tinfo, value $env_125, value $l_126)
{
  struct stack_frame frame;
  value root[2];
  register value $y_127;
  register value $z_128;
  register value $zs_129;
  register value $y_proj_130;
  register value $y_132;
  register value $y_proj_133;
  register value $y_135;
  register value $y_proj_136;
  ...
  frame.prev = (*$tinfo).fp;
  if (($l_126 & 1) == 0) {
    switch (*((value *) $l_126 + -1LL) & 255LL) {
      default:
        $z_128 = *((value *) $l_126 + 0LL);
        $zs_129 = *((value *) $l_126 + 1LL);
        $y_proj_130 = *((value *) $env_125 + 0LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 1LL) = $zs_129;
        *(root + 0LL) = $env_125;
        ...
        $y_132 =
          ...
          ($tinfo, $y_proj_130, $z_128);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        $zs_129 = *(root + 1LL);
        $env_125 = *(root + 0LL);
        (*$tinfo).fp = frame.prev;
        $y_proj_133 = *((value *) $env_125 + 1LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 1LL) = $zs_129;
        *(root + 0LL) = $env_125;
        ...
        $y_135 =
          ((value (*)(struct thread_info *, value, value)) add_uncurried_known_101)
          ($tinfo, $y_proj_133, $y_132);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        $zs_129 = *(root + 1LL);
        $env_125 = *(root + 0LL);
        (*$tinfo).fp = frame.prev;
        $y_proj_136 = *((value *) $env_125 + 2LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 1LL) = $zs_129;
        ...
        *(root + 0LL) = $y_138;
        ...
        (*$tinfo).fp = &frame;
        $y_139 =
          ((value (*)(struct thread_info *, value, value)) aux_104)
          ($tinfo, $env_125, $zs_129);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        if (!(3LL <= $limit - $alloc)) {
          *(root + 1LL) = $y_139;
        ...
        $alloc = $alloc + 3LL;
        *((value *) $y_140 + -1LL) = 2048LL;
        *((value *) $y_140 + 0LL) = $y_138;
        *((value *) $y_140 + 1LL) = $y_139;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        return $y_140;
        break;
...
value repeat_uncurried_known_103(struct thread_info *$tinfo, value $n_119, value $x_120)
{
  struct stack_frame frame;
  value root[2];
  register value $y_121;
  register value $k_122;
    ...
    switch (*((value *) $n_119 + -1LL) & 255LL) {
      default:
        ...
        *(root + 0LL) = $x_120;
        ...
        (*$tinfo).fp = &frame;
        $y_123 =
          ((value (*)(struct thread_info *, value, value)) repeat_uncurried_known_103)
          ($tinfo, $k_122, $x_120);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        if (!(3LL <= $limit - $alloc)) {
        ...
        $alloc = $alloc + 3LL;
        *((value *) $y_124 + -1LL) = 2048LL;
        *((value *) $y_124 + 0LL) = $x_120;
        *((value *) $y_124 + 1LL) = $y_123;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        return $y_124;
        break;
...
value mul_uncurried_known_102(struct thread_info *$tinfo, value $m_112, value $n_113)
{
  struct stack_frame frame;
  value root[2];
  register value $y_114;
  register value $p_115;
  ...
  frame.prev = (*$tinfo).fp;
  if (($n_113 & 1) == 0) {
    switch (*((value *) $n_113 + -1LL) & 255LL) {
      default:
        $p_115 = *((value *) $n_113 + 0LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 0LL) = $m_112;
        ...
        (*$tinfo).fp = &frame;
        $y_116 =
          ((value (*)(struct thread_info *, value, value)) mul_uncurried_known_102)
          ($tinfo, $m_112, $p_115);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        $m_112 = *(root + 0LL);
...
value add_uncurried_known_101(struct thread_info *$tinfo, value $m_106, value $n_107)
{
  struct stack_frame frame;
  value root[2];
  register value $p_108;
  ...
  frame.prev = (*$tinfo).fp;
  if (($n_107 & 1) == 0) {
    switch (*((value *) $n_107 + -1LL) & 255LL) {
      default:
        $p_108 = *((value *) $n_107 + 0LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        /*skip*/;
        ...
        $alloc = $alloc + 2LL;
        *((value *) $y_110 + -1LL) = 1024LL;
        *((value *) $y_110 + 0LL) = $y_109;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        return $y_110;
        break;
...
value body(struct thread_info *$tinfo)
{
  ...
  register value $env_757;
  register value $CertiCoqdTestsdtestsdrec_clos_758;
  register value *$alloc;
  register value *$limit;
  register value *$args;
  $alloc = (*$tinfo).alloc;
  ...
  *(root + 0LL) = $y_142;
  ...
  $y_142 = *(root + 0LL);
  (*$tinfo).fp = frame.prev;
  $env_757 = (value) ($alloc + 1LL);
  $alloc = $alloc + 4LL;
  *((value *) $env_757 + -1LL) = 3072LL;
  *((value *) $env_757 + 0LL) = $y_142;
  *((value *) $env_757 + 1LL) = $y_145;
  *((value *) $env_757 + 2LL) = $y_149;
  $args = (*$tinfo).args;
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  /*skip*/;
  $CertiCoqdTestsdtestsdrec_clos_758 =
    ((value (*)(struct thread_info *, value, value)) aux_104)
    ($tinfo, $env_757, $y_756);
  $alloc = (*$tinfo).alloc;
  $limit = (*$tinfo).limit;
  ...
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  return $CertiCoqdTestsdtestsdrec_clos_758;
}


#endif /* CERTICOQ_TESTS_TESTS_REC_CLOS_OPT1_C */
