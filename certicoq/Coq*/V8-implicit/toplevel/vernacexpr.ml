...
(*i $Id: vernacexpr.ml 9860 2007-05-25 14:47:02Z vsiles $ i*)
...
type simple_binder = (lident list  * constr_expr) * Term.impl
...
type local_decl_expr =
  | AssumExpr of lname * Term.impl * constr_expr
  | DefExpr of lname * Term.impl * constr_expr * constr_expr option
