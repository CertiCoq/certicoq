#ifndef CERTICOQ_TESTS_TESTS_LIST_SUM_INT63_TINFO_C
#define CERTICOQ_TESTS_TESTS_LIST_SUM_INT63_TINFO_C
#include <gc_stack.h>
...
#include "CertiCoq.Tests.tests.list_sum_int63_tinfo.h"
extern struct thread_info *make_tinfo(void);
extern value fold_left_uncurried_known_107(struct thread_info *, value, value);
extern value repeat_uncurried_known_106(struct thread_info *, value, value);
extern value body(struct thread_info *);
value fold_left_uncurried_known_107(struct thread_info *, value, value);
value repeat_uncurried_known_106(struct thread_info *, value, value);
value body(struct thread_info *);
unsigned long long const body_info_233[2] = { 200LL, 0LL, };

unsigned long long const repeat_uncurried_known_info_232[4] = { 0LL, 2LL,
  0LL, 1LL, };

unsigned long long const fold_left_uncurried_known_info_231[4] = { 0LL, 2LL,
  0LL, 1LL, };

value fold_left_uncurried_known_107(struct thread_info *$tinfo, value $a0_116, value $l_117)
{
  struct stack_frame frame;
  value root[2];
  register value $b_118;
  register value $t_119;
  register value $prim_120;
  ...
  frame.prev = (*$tinfo).fp;
  if (($l_117 & 1) == 0) {
    switch (*((value *) $l_117 + -1LL) & 255LL) {
      default:
        $b_118 = *((value *) $l_117 + 0LL);
        $t_119 = *((value *) $l_117 + 1LL);
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 0LL) = $t_119;
        frame.next = root + 1LL;
        (*$tinfo).fp = &frame;
        $prim_120 =
          ((value (*)(struct thread_info *, value, value)) add_int63)
          ($tinfo, $a0_116, $b_118);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        $t_119 = *(root + 0LL);
        ...
        (*$tinfo).limit = $limit;
        $result =
          ((value (*)(struct thread_info *, value, value)) fold_left_uncurried_known_107)
          ($tinfo, $prim_120, $t_119);
        return $result;
        break;
...
value repeat_uncurried_known_106(struct thread_info *$tinfo, value $n_109, value $x_110)
{
  struct stack_frame frame;
  value root[2];
  register value $y_111;
  register value $k_112;
    ...
    switch (*((value *) $n_109 + -1LL) & 255LL) {
      default:
        ...
        *(root + 0LL) = $x_110;
        ...
        (*$tinfo).fp = &frame;
        $y_113 =
          ((value (*)(struct thread_info *, value, value)) repeat_uncurried_known_106)
          ($tinfo, $k_112, $x_110);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        if (!(3LL <= $limit - $alloc)) {
...
value body(struct thread_info *$tinfo)
{
  ...
  *((value *) $y_222 + 0LL) = $y_221;
  ...
  $y_224 =
    ((value (*)(struct thread_info *, value, value)) repeat_uncurried_known_106)
    ($tinfo, $y_222, $prim_121);
  $alloc = (*$tinfo).alloc;
  $limit = (*$tinfo).limit;
  /*skip*/;
  $prim_226 = ((value (*)(void)) zero_int63)();
  $args = (*$tinfo).args;
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  /*skip*/;
  ...
  /*skip*/;
  $prim_228 =
    ((value (*)(struct thread_info *, value)) print_int63)
    ($tinfo, $n_227);
  $alloc = (*$tinfo).alloc;
  $limit = (*$tinfo).limit;
  /*skip*/;
  $y_229 = 1LL;
  $prim_230 = ((value (*)(value)) print_new_line)($y_229);
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  return $prim_230;
}
...
#endif /* CERTICOQ_TESTS_TESTS_LIST_SUM_INT63_TINFO_C */
