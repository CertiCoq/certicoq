...
(*i $Id: evarutil.mli 9571 2007-01-31 19:19:28Z notin $ i*)
...
val new_evar :
  evar_defs -> env -> ?src:loc * hole_kind -> impl -> types ->
    evar_defs * constr
(* the same with side-effects *)
val e_new_evar :
  evar_defs ref -> env -> ?src:loc * hole_kind -> impl -> types -> constr
...
val new_evar_instance :
 named_context_val -> evar_defs -> impl -> types -> ?src:loc * hole_kind ->
...
val define_evar_as_arrow :
  evar_defs -> impl -> existential -> evar_defs * types
...
val solve_pattern_eqn : env -> constr list -> impl list -> constr -> constr
...
val split_tycon :
  loc -> env ->  evar_defs -> type_constraint -> 
    evar_defs * (name * impl * type_constraint * type_constraint)
