...
(*i $Id: evd.mli 9878 2007-06-06 17:00:01Z herbelin $ i*)
...
val evar_declare :
  ...
  evar -> impl -> types -> ?src:loc * hole_kind ->
  evar_defs -> evar_defs
...
val meta_impl      : evar_defs -> metavariable -> impl
val meta_name      : evar_defs -> metavariable -> name
val meta_with_name : evar_defs -> identifier -> metavariable
val meta_declare   :
  metavariable -> impl -> types -> ?name:name -> evar_defs -> evar_defs
