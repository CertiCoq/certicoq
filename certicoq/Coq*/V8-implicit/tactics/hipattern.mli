...
type app_matching_function =
    (constr * constr list * impl list) matching_function
type testing_function = constr -> bool

val match_with_non_recursive_type : app_matching_function
val is_non_recursive_type         : testing_function 

val match_with_disjunction : app_matching_function
val is_disjunction         : testing_function 

val match_with_conjunction : app_matching_function
...
val match_with_equation    : app_matching_function
...
val match_with_forall_term    :
  (name * impl * constr * constr) matching_function
val is_forall_term            : testing_function 

val match_with_imp_term    : (impl * constr * constr) matching_function
...
val match_with_nodep_ind   :
  (constr * constr list * impl list * int) matching_function  
val is_nodep_ind           : testing_function 

val match_with_sigma_type   : app_matching_function	  
