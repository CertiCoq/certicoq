...
Inductive occurs_free_val: L6.cps.val -> Ensemble var :=
| OF_Vconstr :
    forall c vs v x, 
    occurs_free_val v x ->
    List.In v vs ->
...
Lemma var_dec_eq : decidable_eq var. unfold decidable_eq, decidable; decide equality. Qed.
...
Ltac inList := repeat ((now left)||right).
...
Section RELATION.
  ...
  Variable finfo_env: L6_to_Clight.fun_info_env. (* map from a function name to its type info *)
  Variable p:program.
...
| Rint_v: forall  z r m,
    ...
    repr_val_L6_L7 (L6.cps.Vint z) m (make_vint r)
| Rconstr_unboxed_v:
    forall t arr n m,
      M.get t rep_env = Some (enum arr) ->
      repr_unboxed_L7 arr n ->
      repr_val_L6_L7 (L6.cps.Vconstr t nil) m  (make_vint n)
...
with repr_val_ptr_list_L6_L7: (list L6.cps.val) -> mem -> block -> ptrofs -> Prop := 
     | Rnil_l:
         forall m b i,
           repr_val_ptr_list_L6_L7 nil m b i
     | Rcons_l:
         forall v vs m b i v7,
           Mem.load int_chunk m b (Ptrofs.unsigned  i) = Some v7 ->
           repr_val_L6_L7 v m v7 -> 
           repr_val_ptr_list_L6_L7 vs m b (Ptrofs.add i (Ptrofs.repr int_size)) ->
           repr_val_ptr_list_L6_L7 (v::vs) m b i.
...
| RSint_v: forall L z r m,
    repr_unboxed_L7 (Z.to_N z) r ->
    repr_val_L_L6_L7 (L6.cps.Vint z) m L (make_vint r)
| RSconstr_unboxed_v:
    forall t arr n m L,
      M.get t rep_env = Some (enum arr) ->
      repr_unboxed_L7 arr n ->
      repr_val_L_L6_L7 (L6.cps.Vconstr t nil) m L (make_vint n)
...
with repr_val_ptr_list_L_L6_L7: (list L6.cps.val) -> mem -> locProp -> block -> ptrofs -> Prop := 
     ...
     | RScons_l:
         forall v vs m (L:block -> Z -> Prop) b i v7,
           ...
           repr_val_ptr_list_L_L6_L7 vs m L b (Ptrofs.add i (Ptrofs.repr int_size)) ->
           repr_val_ptr_list_L_L6_L7 (v::vs) m L b i.

Scheme repr_val_L_L6_L7_rec := Induction for repr_val_L_L6_L7 Sort Prop
  with repr_val_ptr_list_L_L6_L7_rec := Induction for repr_val_ptr_list_L_L6_L7 Sort Prop.
...
Theorem repr_val_ptr_list_Z:
  ...
  repr_val_ptr_list_L_L6_L7 vs m L b i <-> repr_val_ptr_list_L_L6_L7_Z vs m L b (Ptrofs.unsigned i).
Proof.
  induction vs; intros.
 ...
 *)
Fixpoint reachable_val_L7 (v6:L6.cps.val) (m:mem) (v7:Values.val) (q_b:block) (q_ofs:ptrofs): Prop :=
  match v6, v7 with
                            ...
                            (match Val.cmpu_bool (Mem.valid_pointer m) Ceq (Vptr p_b p_ofs) (Vptr q_b q_ofs) with
                             ...
                             | _ => 
                               (match Mem.load int_chunk m p_b (Ptrofs.unsigned p_ofs) with
                                | Some v7 => 
                                  (reachable_val_L7 v m v7 q_b q_ofs, (p_b, (Ptrofs.add p_ofs (Ptrofs.repr (sizeof (M.empty composite) val)))))
                                | _ => curr
                                end)
                             end))                        
                        vs (False, (b,i))))
...
Theorem repr_val_load_result: forall v6 m v7,
    repr_val_L6_L7 v6 m (Val.load_result int_chunk v7)
                   <->
...
Theorem repr_val_L_load_result: forall v6 m v7 L,
    repr_val_L_L6_L7 v6 m L (Val.load_result int_chunk v7)
                   <->
  repr_val_L_L6_L7 v6 m L v7.
Proof.
  intros.
 ...
 *)
Inductive related_boxed_L7: mem -> (block *  ptrofs) -> mem -> (block *  ptrofs) -> Prop :=
| SV_constr_boxed :
    ...
    (* same tag *)
      ...
      For_N_blocks (fun loc loc' => related_boxed_or_same_val_L7 m loc m' loc') (b,i) (b', i') (Ptrofs.repr (sizeof (M.empty composite) val)) (N.to_nat a) -> 
      related_boxed_L7 m (b,i) m' (b', i')
with related_boxed_or_same_val_L7: mem -> (block *  ptrofs) -> mem -> (block * ptrofs) -> Prop :=
     | RBSI_fun :
         (* same fun *)
...
Theorem repr_val_ptr_load :
  forall v6 m b i,
    ...
    (exists v7, Mem.load int_chunk m b (Int.unsigned i)  = Some v7 /\ repr_val_L6_L7 v6 m v7)
...
Definition correct_environments_for_function:
  ...
  := fun ge fenv finfo_env m fds f t vs e =>
       exists l locs finfo b, 
         ...
         (* TODO: change this to repr_val_L6_L7 *)
         repr_val_L6_L7 (cps.Vfun (M.empty cps.val) fds f) m (Vptr b Ptrofs.zero).
...
Theorem is_protected_tinfo_weak:
  forall x, is_protected_tinfo_id x ->
            is_protected_id x.
Proof.
  intros. admit; repeat destruct H; subst; inList. 
Admitted.
...
Proof.
  ...
  apply H.
  admit; eapply bound_var_subterm_e; eauto.
  apply H.
Admitted.  
...
Definition protected_non_reachable_val_L7 v6 m v7 (lenv:temp_env) : Prop :=
      exists alloc_b alloc_ofs limit_b limit_ofs args_b args_ofs,
        ...
        (forall i,
            ...
            ~reachable_val_L7 v6 m v7 args_b (Ptrofs.add args_ofs (Ptrofs.mul (Ptrofs.repr int_size) i))).
...
Notation valPtr := (Tpointer vval
  ...
  Definition repr_val_id_L_L6_L7_thm := repr_val_id_L_L6_L7 argsIdent allocIdent limitIdent gcIdent threadInfIdent tinfIdent isptrIdent caseIdent nParam.

  Definition repr_val_L6_L7_thm := repr_val_L6_L7 argsIdent allocIdent limitIdent gcIdent threadInfIdent tinfIdent isptrIdent caseIdent nParam. 
...
(* everything in cenv is in ienv, AND there is a unique entry for it, AND its ord is not reused 
  ...
  Definition correct_ienv_of_cenv: L6.cps.ctor_env -> n_ind_env -> Prop :=
    fun cenv ienv =>
      forall x i a ord name name',
      M.get x cenv = Some (Build_ctor_ty_info name name' i a ord) ->
      exists  namei cl, M.get i ienv = Some (namei, cl) /\
                   List.In (Build_ctor_ty_info name namei i a ord) cl /\
                   ~ (exists ord' name' a', (name', a', ord') <> (name, a, ord) /\
                                       List.In (Build_ctor_ty_info name' namei i a' ord') cl) /\
                   ~ (exists name' i' a', (name', i', a') <> (name, i, a) /\
                                     List.In (Build_ctor_ty_info name' namei i' a' ord) cl).
  ...
  Definition domain_ienv_cenv:  L6.cps.ctor_env -> n_ind_env -> Prop :=
    fun cenv ienv =>
      ...
      forall name x a ord, List.In (Build_ctor_ty_info namei name x a ord) cl ->
...
(* stronger version of ienv_of_cenv that enforces uniqueness of name' for i and that nothing is in ienv and not in cenv *)
  ...
  Definition correct_crep_of_env: L6.cps.ctor_env -> M.t ctor_rep -> Prop :=
    fun cenv crep_env =>
      (forall c name namei it a n,
...
Definition repr_val_L_L6_L7_id := repr_val_L_L6_L7 argsIdent allocIdent limitIdent gcIdent threadInfIdent tinfIdent isptrIdent caseIdent nParam. 

Definition repr_val_id_L_L6_L7_id := repr_val_id_L_L6_L7
...
Inductive nth_arg_rel_L6_L7 (fenv:fun_env) (finfo_env:fun_info_env) (p:program) (rep_env: M.t ctor_rep) : L6.eval.env -> positive -> temp_env -> mem -> Z -> Prop :=
| is_in_and_rel:
...
Proof.
  ...
  - intros.
    ...
    +    
*)
Definition arg_val_L6_L7 (fenv:fun_env) (finfo_env:fun_info_env) (p:program) (rep_env: M.t ctor_rep): L6.cps.val -> mem -> temp_env -> Prop :=
  fun v m lenv =>
...
(*       M.get tinfIdent lenv = Some (Vptr tinf_b tinf_ofs) /\
      ...
      M.get argsIdent lenv = Some (Vptr args_b args_ofs) /\ 
                                  Mem.load int_chunk m args_b (Ptrofs.unsigned (Ptrofs.add args_ofs (Ptrofs.repr int_size))) = Some L7v /\
  ...
  forall lenv p rho L rep_env finfo_env argsIdent allocIdent limitIdent gcIdent threadInfIdent tinfIdent isptrIdent caseIdent nParam fenv
         m xs vs,
            ( forall x, List.In x xs ->
                        exists v6 : cps.val,
         M.get x rho = Some v6 /\
         repr_val_id_L_L6_L7 argsIdent allocIdent limitIdent gcIdent threadInfIdent tinfIdent isptrIdent caseIdent nParam fenv finfo_env
...
Proof.  
  ...
  - simpl in H0.
    ...
    assert ((forall x : positive,
          ...
          exists v6 : cps.val,
            M.get x rho = Some v6 /\
            repr_val_id_L_L6_L7 argsIdent0 allocIdent0 limitIdent0 gcIdent0 threadInfIdent0 tinfIdent0 isptrIdent0 caseIdent0 nParam0
    ...
    assert 
      (exists v6 : cps.val,
        M.get a rho = Some v6 /\
        repr_val_id_L_L6_L7 argsIdent0 allocIdent0 limitIdent0 gcIdent0 threadInfIdent0 tinfIdent0 isptrIdent0 caseIdent0 nParam0 fenv
...
(* Two constructors of the same inductive cannot have the same ordinal 
   ...
   This no longer goes through because correct_ienv_of_cenv isn't strong enough *)
...
Proof.
  ...
  - (* c -> ord *)
    apply H7. exists namec', c', a'.  split. intro. inv H8. admit; apply H0; auto. auto.
Admitted.
(*  - (* ord -> c *)
...
Theorem case_of_labeled_stm_unboxed:
  ...
  findtag cl t = Some e ->
  repr_branches_L6_L7 argsIdent allocIdent limitIdent threadInfIdent tinfIdent isptrIdent caseIdent nParam fenv finfo_env p rep_env cl ls ls' ->
  exists s s', 
    seq_of_labeled_statement (select_switch (Z.shiftr n0 1) ls') = (Ssequence (Ssequence s Sbreak) s') /\  repr_expr_L6_L7_id fenv finfo_env p rep_env e s.
Proof.
...
Theorem case_of_labeled_stm_boxed:
  ...
  repr_branches_L6_L7 argsIdent allocIdent limitIdent threadInfIdent tinfIdent isptrIdent caseIdent nParam fenv finfo_env p rep_env cl ls ls' ->
  exists s s', 
                       (seq_of_labeled_statement (select_switch (Z.land  h 255) ls)) = (Ssequence (Ssequence s Sbreak) s') /\  repr_expr_L6_L7_id fenv finfo_env p rep_env e s.
Proof. 
...
Proof.
  ...
  - unfold make_ctor_rep in H_make_ctor_rep. rewrite H0 in H_make_ctor_rep. simpl in *.
    ...
    { split. unfold makeTagZ in *. unfold make_ctor_rep in *.
      rewrite H3 in H_makeTagZ. simpl Monad.bind in H_makeTagZ.
      inv H_makeTagZ; auto.
      split; auto.  }
    apply nth_proj_assign. auto.
...
Theorem translate_body_correct:
  forall fenv cenv ienv  p rep_env map,
    ...
    repr_expr_L6_L7_id fenv map p rep_env e stm.
Proof.
    ...
    assert ( domain_ienv_cenv (Maps.PTree.set k v m) (update_ind_env a k v)).
    {
      ...
      + destruct n.
        ...
        * subst. rewrite M.gss in H5. inv H5. inv H6.
          (* k = x *)
          admit. (*inv H5. eexists. apply M.gss.*)
          (* k <> x *)
      ...
      + destruct (var_dec i ctor_ind_tag).
        * subst. rewrite M.gss in H5. inv H5. inv H6. inv H5. admit. (*exists namei. apply M.gss. *) inv H5.
      ...
      apply H4 in H6. destructAll.
      {
        ...
        - destruct n0. 
          ...
          + subst.
            ...
            eexists. admit.
            (*exists  ((ctor_name, k, ctor_arity, ctor_ordinal) :: x1).
      ...
      - (* boxed *)
       ...
       (Maps.PTree.set allocIdent
        ...
        assert (H_m2_m3 :  mem_after_n_proj_store alloc_b
          ...
          chunk_red; archi_red; simpl sizeof; omega. etransitivity. eauto.
          rewrite Zplus_minus. apply Ptrofs.unsigned_range_2.
          unfold Z.one.
          rewrite Z.mul_succ_r in H4.
          assert (0 <= Ptrofs.unsigned alloc_ofs)%Z by apply Ptrofs.unsigned_range_2. split. chunk_red; archi_red; simpl sizeof; omega.  
          assert (Ptrofs.unsigned alloc_ofs +  sizeof (globalenv p) uval * 1 <= Ptrofs.unsigned alloc_ofs + ( Ptrofs.unsigned limit_ofs - Ptrofs.unsigned alloc_ofs))%Z by (chunk_red; archi_red; simpl sizeof; omega). 
          etransitivity. eauto.
          rewrite Zplus_minus. apply Ptrofs.unsigned_range_2.
          ...
          - (* protected okay since only took the space from Econstr to e *)
            ...
            + intros.
              ...
              * simpl sizeof.
                ...
                rewrite Ptrofs.unsigned_repr. reflexivity.
                split. apply Z.mul_nonneg_nonneg. chunk_red; archi_red; simpl sizeof; omega. 
                apply N2Z.is_nonneg.
                rewrite <- Z.le_add_le_sub_l in H12.    
                ...
                simpl Z.of_N.
                rewrite Z.mul_add_distr_l.
                rewrite Z.mul_add_distr_l. chunk_red; archi_red; simpl sizeof; omega.
                apply Ptrofs.unsigned_range_2.
                rewrite ptrofs_mu. 
          ...
          - intros. destruct (var_dec x0 x).
                 + (* x0 = x *)
                   ...
                   * (* skip m3, (repr H) is what is stored for m2 *)
                     ...
                     rewrite Ptrofs.unsigned_repr with (z := (sizeof (prog_comp_env p) uval)). 
                     rewrite Ptrofs.unsigned_repr.                     
                     unfold int_size; chunk_red; archi_red; simpl sizeof; omega.
                     split.
                     apply Z_non_neg_add.
                     chunk_red; archi_red; simpl sizeof; omega. apply Ptrofs.unsigned_range.
                     destruct Hbound_limit.
                     ...
                     chunk_red; archi_red; simpl sizeof; omega.
                     apply Ptrofs.unsigned_range_2.
                     rewrite ptrofs_mu.
                     unfold sizeof; chunk_red; archi_red; solve_uint_range; omega.
                   * 
                   ...
                   * (* todo: theorem linking repr_val_ptr_list and mem_after_n_proj_store *)
                     ...
                     { clear IHHev.
                                          ...
                                          = (Ptrofs.unsigned alloc_ofs) + int_size)%Z).
                       {
                         ...
                         inv Hc_alloc.
                         split. apply OrdersEx.Z_as_OT.add_nonneg_nonneg. apply Ptrofs.unsigned_range.  chunk_red; archi_red; simpl sizeof; omega. 
                    inv Hbound_limit.
                    rewrite <- Z.le_add_le_sub_l in H5.  
...
(*   Not needed w/o maxalloc in pniL
               assert (Hrel_pL' :  protected_not_in_L argsIdent allocIdent limitIdent tinfIdent p lenv (Z.succ (Z.of_nat (max_allocs e)) + Z.of_nat (length vs7) )%Z L). {                                        
                  ...
                  assert (forall y, List.In y ys -> 
                                    exists v6 : cps.val,
              M.get y rho = Some v6 /\
              repr_val_id_L_L6_L7 argsIdent allocIdent limitIdent gcIdent threadInfIdent tinfIdent isptrIdent caseIdent nParam fenv
                  ...
                  assert (H_repr_a0: repr_val_L_L6_L7_id fenv finfo_env p rep_env a0 m3 L'  (Val.load_result int_chunk y0)). {
...
*)                                
        ...
        { (* correct_tinfo after adding the constructor *)
          ...
          omega.
          intro; apply H3.
          eapply (@is_protected_tinfo_weak argsIdent allocIdent limitIdent gcIdent mainIdent bodyIdent threadInfIdent tinfIdent heapInfIdent numArgsIdent isptrIdent caseIdent nParam cenv fenv _ p rep_env). auto.
          ...
          (* alloc is moved to an OK location *)
          {
            ...
            intro.  apply H3. rewrite <- H4; inList.
            subst.
            assert (tinf_b' = tinf_b /\ tinf_ofs' = tinf_ofs). rewrite M.gso in Htinf1'. rewrite Htinf1' in Htinf1; inv Htinf1; auto. intro. apply H3. subst. inList. destruct H4; subst. split.
            do 7 eexists. split.
            rewrite M.gss. reflexivity.
            split.
            (* align *)
            ...
            constructor. chunk_red; archi_red; simpl sizeof; omega. rewrite ptrofs_mu. chunk_red; archi_red; solve_uint_range; omega.
            constructor. 
            split.
            apply N2Z.is_nonneg.
            inv Hbound_limit.
...
*) 
            ...
            apply Ptrofs.unsigned_range_2.
            split.             chunk_red; archi_red; simpl sizeof; omega.
      ...
      - (* unboxed *)
        ...
        + split.
          ...
          inv Hp_id.
          eapply H4.
          eapply (@is_protected_tinfo_weak argsIdent allocIdent limitIdent gcIdent mainIdent bodyIdent threadInfIdent tinfIdent heapInfIdent numArgsIdent isptrIdent caseIdent nParam cenv fenv _ p rep_env). eauto. eauto.
          { inv Hp_id.
            intro; subst.
            eapply H3.
            2: constructor.
    ...
    assert (Hf_id_e:  functions_not_bound p (cps.M.set x (Vconstr t vs) rho) e). {
      eapply (@functions_not_bound_subterm argsIdent allocIdent limitIdent gcIdent mainIdent bodyIdent threadInfIdent tinfIdent heapInfIdent numArgsIdent isptrIdent caseIdent nParam cenv fenv _ p rep_env).
  ...
  - (* Ecase *)     
    ...
    assert (Hstep_case:
        exists vbool s s', 
         ...
         repr_expr_L6_L7_id fenv finfo_env p rep_env e s).
    {
      inv Hrepr_y.
      - (* unboxed *)
        exists (Vfalse).
        assert (exists s s', seq_of_labeled_statement (select_switch (Z.shiftr n0 1) ls') = (Ssequence (Ssequence s Sbreak) s') /\  repr_expr_L6_L7_id fenv finfo_env p rep_env e s).
    ...
    assert (Hmem_e : rel_mem_L6_L7_id fenv finfo_env p rep_env e rho m  (Maps.PTree.set caseIdent vbool lenv)).
    {
      ...
      -  eapply protected_not_in_L_set.
        ...
        replace [allocIdent; limitIdent; gcIdent; mainIdent; bodyIdent; threadInfIdent; tinfIdent; heapInfIdent;
                 numArgsIdent; numArgsIdent; isptrIdent; caseIdent]
          with ([allocIdent; limitIdent; gcIdent; mainIdent; bodyIdent; threadInfIdent; tinfIdent; heapInfIdent]
               ++[numArgsIdent; numArgsIdent; isptrIdent; caseIdent]) in * by reflexivity.
        apply NoDup_cons_r in H23. inversion H23. apply H24; inList. 
      - intros. 
                           ...
                           (Maps.PTree.set caseIdent vbool lenv) m ).
    {
      ...
      inv Hdj.
      inv H. rename H2 into Heql.
      inv H6. apply H3; inList.      
      destruct H2; subst.
      rename H into Heql'. inv H6. inv H7. apply H6; inList.
      rename H into Heql''. 
      apply H5; inList.
      assert (Hdj:=disjointIdent).
      inv Hdj.
      intro. inv H5. rename H into Heql'''. inv H8.
...
(*   
              ...
              | Some bef =>
                ...
                | Some aft =>
                  Some
                    (Sifthenelse
                       (not
                          (Ebinop Ole (Ederef (Evar finfo0 (Tarray L6_to_Clight.uval (Z.of_N (N.of_nat (length locs) + 2)) noattr)) L6_to_Clight.uval)
                    ...
                    (Ssequence bef
                               (Scall None
                                      (Evar gcIdent
                                            (Tfunction (Tcons (Tpointer uval noattr) (Tcons (Tpointer (Tstruct threadInfIdent noattr) noattr) Tnil)) Tvoid
                                                       {| cc_vararg := false; cc_unproto := false; cc_structret := false |}))
                                      [Evar finfo0 (Tarray L6_to_Clight.uval (Z.of_N (N.of_nat (length locs) + 2)) noattr); Etempvar tinfIdent (Tpointer (Tstruct threadInfIdent noattr) noattr)])) aft)
                 Sskip)).
    ...
    assert (rel_mem_gc : rel_mem_L6_L7_id fenv finfo_env p rep_env (Ehalt 1%positive) rho m4 lenv_new).
    {
      admit.
    }
    ...
    (*
    NEED:
      rel_mem_L6_L7_id fenv finfo_env p rep_env (Ehalt 1%positive) rho m4 lenv
    ...
    { (*
      ...
      eexists. eexists.   
      repeat weak_split. 
      - remember  (not (Ebinop Ole (Ederef (Evar finfo0 (Tarray L6_to_Clight.uval (Z.of_N (N.of_nat (length locs) + 2)) noattr)) L6_to_Clight.uval)
                               (sub (Efield (Ederef (Etempvar tinfIdent (Tpointer (Tstruct threadInfIdent noattr) noattr)) (Tstruct threadInfIdent noattr)) limitIdent valPtr)
          ...
          - econstructor. econstructor. econstructor. constructor. econstructor. constructor 2. apply M.gempty. eauto.
            ...
            assert (
                sem_cmp Cle (make_vint fi_0_m4) uval
                        ...
                        (Tpointer L6_to_Clight.val {| attr_volatile := false; attr_alignas := None |}) m4 =
        ...
        assert (Hgc_case : (((Ptrofs.unsigned limit_ofs - Ptrofs.unsigned alloc_ofs) / int_size) <?  max_alloc' = gc_test_b)%Z).
        {
          ...
          2: { right. rewrite Ptrofs.add_zero. simpl.
             ...
             rewrite Hfinfo_env_f' in H7; inv H7.
               ...
               assert (
                   sem_cmp Cle (make_vint fi_0_m4) L6_to_Clight.uval (Vptrofs (Ptrofs.divs (Ptrofs.sub limit_ofs alloc_ofs) (Ptrofs.repr (sizeof (prog_comp_env p) uval)))) valPtr m4 =
                   Some (Val.of_bool (negb (Ptrofs.ltu (Ptrofs.divs (Ptrofs.sub limit_ofs alloc_ofs) (Ptrofs.repr int_size)) (Ptrofs.repr fi_0_m4))))).
               {
                 unfold sem_cmp. simpl. chunk_red; archi_red; simpl; unfold cmp_ptr; archi_red; unfold Val.cmplu_bool; unfold Vptrofs; archi_red; simpl. unfold Int64.ltu. unfold Ptrofs.to_int64. rewrite Int64.unsigned_repr.  rewrite Int64.unsigned_repr.
                 unfold Ptrofs.ltu. unfold Ptrofs.of_int64.  rewrite ptrofs_of_int64. reflexivity. unsigned_ptrofs_range.
               ...
               Set Printing All. unfold L6_to_Clight.valPtr in H16. rewrite H16 in H1.
      ...
      *             (* correct_tinfo m5 *)            
      ...
      - 
        ...
        eapply t_step.  eapply step_ifthenelse. unfold  L6_to_Clight.uval in *; unfold  L6_to_Clight.val in *; unfold val in *; unfold uval in *. rewrite <-   Heqgc_test. 
        eauto.
        unfold  L6_to_Clight.uval in *; unfold  L6_to_Clight.val in *; unfold val in *; unfold uval in *. rewrite <-   Heqgc_test.  
        eauto. reflexivity.
        split. 
