#ifndef CERTICOQ_TESTS_TESTS_REC_CLOS2_OPT4_C
#define CERTICOQ_TESTS_TESTS_REC_CLOS2_OPT4_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Tests.tests.rec_clos2_opt4.h"
extern struct thread_info *make_tinfo(void);
extern value aux_uncurried_known_104(struct thread_info *, value, value, value, value, value);
extern value repeat_uncurried_known_103(struct thread_info *, value, value);
extern value add_uncurried_known_102(struct thread_info *, value, value);
extern value mul_uncurried_known_101(struct thread_info *, value, value);
extern value body(struct thread_info *);
value aux_uncurried_known_104(struct thread_info *, value, value, value, value, value);
value repeat_uncurried_known_103(struct thread_info *, value, value);
value add_uncurried_known_102(struct thread_info *, value, value);
value mul_uncurried_known_101(struct thread_info *, value, value);
value body(struct thread_info *);
unsigned long long const body_info_760[2] = { 1212LL, 0LL, };

unsigned long long const mul_uncurried_known_info_759[4] = { 0LL, 2LL, 0LL,
  1LL, };

unsigned long long const add_uncurried_known_info_758[4] = { 0LL, 2LL, 0LL,
  1LL, };

unsigned long long const repeat_uncurried_known_info_757[4] = { 0LL, 2LL,
  0LL, 1LL, };

unsigned long long const aux_uncurried_known_info_756[7] = { 12LL, 5LL, 0LL,
  1LL, 2LL, 3LL, 4LL, };

value aux_uncurried_known_104(struct thread_info *$tinfo, value $acc_126, value $l_127, value $y_128, value $y_129, value $y_130)
{
  struct stack_frame frame;
  value root[5];
  register value $z_131;
  register value $zs_132;
  ...
  if (($l_127 & 1) == 0) {
    switch (*((value *) $l_127 + -1LL) & 255LL) {
      default:
        $z_131 = *((value *) $l_127 + 0LL);
        $zs_132 = *((value *) $l_127 + 1LL);
        $y_133 = (value) ($alloc + 1LL);
        $alloc = $alloc + 3LL;
        *((value *) $y_133 + -1LL) = 2048LL;
        *((value *) $y_133 + 0LL) = $y_130;
        *((value *) $y_133 + 1LL) = $acc_126;
        $y_134 = (value) ($alloc + 1LL);
        $alloc = $alloc + 3LL;
        *((value *) $y_134 + -1LL) = 2048LL;
        *((value *) $y_134 + 0LL) = $y_129;
        *((value *) $y_134 + 1LL) = $y_133;
        $y_135 = (value) ($alloc + 1LL);
        $alloc = $alloc + 3LL;
        *((value *) $y_135 + -1LL) = 2048LL;
        *((value *) $y_135 + 0LL) = $y_128;
        *((value *) $y_135 + 1LL) = $y_134;
        $y_136 = (value) ($alloc + 1LL);
        $alloc = $alloc + 3LL;
        *((value *) $y_136 + -1LL) = 2048LL;
        *((value *) $y_136 + 0LL) = $z_131;
        *((value *) $y_136 + 1LL) = $y_135;
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        $result =
          ((value (*)(struct thread_info *, value, value, value, value, value)) 
            aux_uncurried_known_104)
          ($tinfo, $y_136, $zs_132, $y_128, $y_129, $y_130);
        return $result;
        break;
...
value add_uncurried_known_102(struct thread_info *$tinfo, value $m_113, value $n_114)
{
  struct stack_frame frame;
  value root[2];
  ...
  frame.prev = (*$tinfo).fp;
  if (($n_114 & 1) == 0) {
    switch (*((value *) $n_114 + -1LL) & 255LL) {
      default:
        $p_115 = *((value *) $n_114 + 0LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        /*skip*/;
        $y_116 =
          ((value (*)(struct thread_info *, value, value)) add_uncurried_known_102)
          ($tinfo, $m_113, $p_115);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        if (!(2LL <= $limit - $alloc)) {
...
value mul_uncurried_known_101(struct thread_info *$tinfo, value $m_106, value $n_107)
{
  struct stack_frame frame;
  value root[2];
    ...
    switch (*((value *) $n_107 + -1LL) & 255LL) {
      default:
        ...
        *(root + 0LL) = $m_106;
        ...
        (*$tinfo).fp = &frame;
        $y_111 =
          ((value (*)(struct thread_info *, value, value)) mul_uncurried_known_101)
          ($tinfo, $m_106, $p_109);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        $m_106 = *(root + 0LL);
...
value body(struct thread_info *$tinfo)
{
  ...
  register value $CertiCoqdTestsdtestsdrec_clos2_755;
  register value *$alloc;
  register value *$limit;
  register value *$args;
  $alloc = (*$tinfo).alloc;
  ...
  *(root + 0LL) = $y_138;
  ...
  (*$tinfo).limit = $limit;
  /*skip*/;
  $CertiCoqdTestsdtestsdrec_clos2_755 =
    ((value (*)(struct thread_info *, value, value, value, value, value)) 
      aux_uncurried_known_104)
    ($tinfo, $y_754, $y_752, $y_138, $y_141, $y_145);
  $alloc = (*$tinfo).alloc;
  $limit = (*$tinfo).limit;
  /*skip*/;
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  return $CertiCoqdTestsdtestsdrec_clos2_755;
}


#endif /* CERTICOQ_TESTS_TESTS_REC_CLOS2_OPT4_C */
