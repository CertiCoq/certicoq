...
Proof.
  ...
  - inversion_Clear H1. constructor; try assumption.
    apply H; try assumption. lia. apply (proj1 Crct_up). assumption.
  - inversion_Clear H2. constructor; try assumption.
    + apply H; assumption.
    + apply H0. lia. assumption. apply (proj1 Crct_up). assumption.
  ...
  - pose proof (InstantiateDefs_pres_dlength i) as k.
    inversion_Clear H1. constructor; try lia. apply H. lia.
    + replace (S (m0 + dlength id)) with (S m0 + dlength d); try lia.
      assumption.
