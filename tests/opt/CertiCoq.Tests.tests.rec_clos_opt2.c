#ifndef CERTICOQ_TESTS_TESTS_REC_CLOS_OPT2_C
#define CERTICOQ_TESTS_TESTS_REC_CLOS_OPT2_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Tests.tests.rec_clos_opt2.h"
...
unsigned long long const body_info_754[2] = { 1212LL, 0LL, };

unsigned long long const add_uncurried_known_info_753[4] = { 0LL, 2LL, 0LL,
  1LL, };

unsigned long long const mul_uncurried_known_info_752[4] = { 0LL, 2LL, 0LL,
  1LL, };

unsigned long long const repeat_uncurried_known_info_751[4] = { 0LL, 2LL,
  0LL, 1LL, };

unsigned long long const aux_info_750[4] = { 0LL, 2LL, 0LL, 1LL, };

value aux_104(struct thread_info *$tinfo, value $env_121, value $l_122)
{
  struct stack_frame frame;
  value root[2];
  register value $y_123;
  register value $z_124;
  register value $zs_125;
  register value $y_proj_126;
  register value $y_127;
  register value $y_proj_128;
  ...
  if (($l_122 & 1) == 0) {
    switch (*((value *) $l_122 + -1LL) & 255LL) {
      default:
        $z_124 = *((value *) $l_122 + 0LL);
        $zs_125 = *((value *) $l_122 + 1LL);
        $y_proj_126 = *((value *) $env_121 + 0LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 1LL) = $zs_125;
        *(root + 0LL) = $env_121;
        ...
        $y_127 =
          ...
          ($tinfo, $y_proj_126, $z_124);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        $zs_125 = *(root + 1LL);
        $env_121 = *(root + 0LL);
        (*$tinfo).fp = frame.prev;
        $y_proj_128 = *((value *) $env_121 + 1LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 1LL) = $zs_125;
        *(root + 0LL) = $env_121;
        ...
        $y_129 =
          ((value (*)(struct thread_info *, value, value)) add_uncurried_known_101)
          ($tinfo, $y_proj_128, $y_127);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        $zs_125 = *(root + 1LL);
        $env_121 = *(root + 0LL);
        (*$tinfo).fp = frame.prev;
        $y_proj_130 = *((value *) $env_121 + 2LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 1LL) = $zs_125;
...
value mul_uncurried_known_102(struct thread_info *$tinfo, value $m_110, value $n_111)
{
  struct stack_frame frame;
  value root[2];
  register value $y_112;
  register value $p_113;
...
value add_uncurried_known_101(struct thread_info *$tinfo, value $m_105, value $n_106)
{
  struct stack_frame frame;
  value root[2];
  register value $p_107;
  ...
  if (($n_106 & 1) == 0) {
    switch (*((value *) $n_106 + -1LL) & 255LL) {
      default:
        ...
        $alloc = $alloc + 2LL;
        *((value *) $y_109 + -1LL) = 1024LL;
        *((value *) $y_109 + 0LL) = $y_108;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        return $y_109;
        break;
...
value body(struct thread_info *$tinfo)
{
  ...
  register value $CertiCoqdTestsdtestsdrec_clos_749;
  register value *$alloc;
  register value *$limit;
  register value *$args;
  $alloc = (*$tinfo).alloc;
  ...
  *(root + 0LL) = $y_135;
  ...
  $y_135 = *(root + 0LL);
  (*$tinfo).fp = frame.prev;
  $env_748 = (value) ($alloc + 1LL);
  $alloc = $alloc + 4LL;
  *((value *) $env_748 + -1LL) = 3072LL;
  *((value *) $env_748 + 0LL) = $y_135;
  *((value *) $env_748 + 1LL) = $y_138;
  *((value *) $env_748 + 2LL) = $y_142;
  $args = (*$tinfo).args;
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  /*skip*/;
  $CertiCoqdTestsdtestsdrec_clos_749 =
    ((value (*)(struct thread_info *, value, value)) aux_104)
    ($tinfo, $env_748, $y_747);
  $alloc = (*$tinfo).alloc;
  $limit = (*$tinfo).limit;
  ...
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  return $CertiCoqdTestsdtestsdrec_clos_749;
}


#endif /* CERTICOQ_TESTS_TESTS_REC_CLOS_OPT2_C */
