...
(*i $Id: topconstr.mli 9718 2007-03-19 16:54:25Z msozeau $ i*)
...
val mkAppC : constr_expr * (constr_expr * impl) list -> constr_expr
val mkCastC : constr_expr * constr_expr cast_type -> constr_expr
val mkLambdaC :
  (name located * impl) list * constr_expr * constr_expr -> constr_expr
val mkLetInC : name located * impl * constr_expr * constr_expr -> constr_expr
val mkProdC :
  (name located * impl) list * constr_expr * constr_expr -> constr_expr
...
val names_of_local_assums :
  local_binder list -> (name located * impl) list
