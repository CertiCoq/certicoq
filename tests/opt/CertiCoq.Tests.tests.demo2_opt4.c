#ifndef CERTICOQ_TESTS_TESTS_DEMO2_OPT4_C
#define CERTICOQ_TESTS_TESTS_DEMO2_OPT4_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Tests.tests.demo2_opt4.h"
...
value body(struct thread_info *$tinfo)
{
  ...
  register value $CertiCoqdTestsdtestsddemo2_235;
  register value *$alloc;
  register value *$limit;
  register value *$args;
  $alloc = (*$tinfo).alloc;
  ...
  *((value *) $y_230 + 0LL) = $y_229;
  ...
  (*$tinfo).limit = $limit;
  /*skip*/;
  $CertiCoqdTestsdtestsddemo2_235 =
    ((value (*)(struct thread_info *, value)) map_known_102)
    ($tinfo, $y_233);
  $alloc = (*$tinfo).alloc;
  $limit = (*$tinfo).limit;
  ...
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  return $CertiCoqdTestsdtestsddemo2_235;
}


#endif /* CERTICOQ_TESTS_TESTS_DEMO2_OPT4_C */
