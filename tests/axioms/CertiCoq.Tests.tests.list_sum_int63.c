#ifndef CERTICOQ_TESTS_TESTS_LIST_SUM_INT63_C
#define CERTICOQ_TESTS_TESTS_LIST_SUM_INT63_C
#include <gc_stack.h>
...
#include <coq_c_ffi.h>
#include "int63.h"
#include "CertiCoq.Tests.tests.list_sum_int63.h"
  ...
  if (($l_117 & 1) == 0) {
    switch (*((value *) $l_117 + -1LL) & 255LL) {
      default:
        ...
        $prim_120 = ((value (*)(value, value)) add_int63)($a0_116, $b_118);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        $result =
...
value body(struct thread_info *$tinfo)
{
  ...
  *((value *) $y_222 + 0LL) = $y_221;
  ...
  $limit = (*$tinfo).limit;
  /*skip*/;
  $prim_228 = ((value (*)(value)) print_int63)($n_227);
  $y_229 = 1LL;
...
#endif /* CERTICOQ_TESTS_TESTS_LIST_SUM_INT63_C */
