...
(*i $Id: Rfunctions.v 9454 2006-12-15 15:30:59Z bgregoir $ i*)
...
Proof.
  intros; induction  n as [| n Hrecn].
  right; reflexivity.
  simpl in |- *; case (Rcase_abs x); intro; apply impl_PI.
...
Proof.
  unfold R_dist in |- *; intros; split_Rabs; apply impl_PI; try ring.
