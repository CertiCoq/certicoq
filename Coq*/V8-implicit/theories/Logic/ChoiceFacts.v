...
(*i $Id: ChoiceFacts.v 9439 2006-12-12 10:39:13Z herbelin $ i*)
...
Proof.
  ...
  intro x.
  apply (ImplicitAxioms.proj2_sig (IndefDescr B (R x) (H x))).
Qed.
...
Proof.
  ...
  intro x.
  apply (ImplicitAxioms.proj2_sig (DefDescr B (R x) (H x))).
Qed.
