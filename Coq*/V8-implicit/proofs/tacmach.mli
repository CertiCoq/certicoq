...
(*i $Id: tacmach.mli 9989 2007-07-12 23:41:01Z glondu $ i*)
...
val pf_whd_betadeltaiota_stack :
  goal sigma -> constr -> constr * constr list * impl list
...
val internal_cut_no_check     : identifier -> impl -> types -> tactic
val internal_cut_rev_no_check : identifier -> impl -> types -> tactic
...
val internal_cut     : identifier -> impl -> types -> tactic
val internal_cut_rev : identifier -> impl -> types -> tactic
