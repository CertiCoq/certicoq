...
Admitted.
(*******************
  destruct main; auto. simpl. induction t; auto.
  - cbn. unfold mkApp. destruct (strip main1); try reflexivity.
    cbn. 

    change
      (flattenApp (mkApp (strip main1) (tunit (strip main2))) =
       (strip main1, [strip main2])).

    unfold mkApp. f_equal. auto.
Qed.
...
Proof.
  ...
  - unfold obsPreserving. intros s sv _ Hev.
    ...
    + cbn. admit.
      (***********
      eapply (proj1 (stripEvalCommute.WcbvEval_hom _) _ _ Hev).
       ****************)
    + reflexivity.
    + apply compileObsEq.
Admitted.
