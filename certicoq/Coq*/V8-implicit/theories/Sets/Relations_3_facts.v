...
elim H'0 using Rstar_ind'; clear H'0.
...
elim (H' x) using noetherian_ind'; auto with sets.
Qed.
...
elim (H' x) using noetherian_ind'; unfold confluent in |- *.
