 ...
 *)
  ...
  (* Instance Equivalence_heap_equiv S : *)
  (*   Equivalence (heap_equiv S).  *)
  (* Proof. *)
  (*   constructor. *)
  ...
  Proof.
    ...
    - replace ((post H1 ^ Datatypes.S n) S)
      ...
      { eapply IHn.
        ...
        simpl in Hres. inv Hinl.
        assert (Hres' := Hres).
        rewrite res_equiv_eq  in Hres. destruct Hres as [Heq' _].
        subst. eassumption.
        
        destruct Hres as [Heq1 [Heq2 Hinq]]. subst.
