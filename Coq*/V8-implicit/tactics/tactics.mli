...
(*i $Id: tactics.mli 9952 2007-07-06 15:31:37Z letouzey $ i*)
...
val head_constr       : constr -> constr * constr list * impl list
val head_constr_bound : constr -> constr * constr list * impl list
...
val apply_type : constr -> constr list -> impl list -> tactic
val apply_term : constr -> constr list -> impl list -> tactic
...
val cut_and_apply         : impl -> constr -> tactic
...
val impE : impl -> identifier -> tactic
...
val cut                         : impl -> types -> tactic
val cut_intro                   : impl -> types -> tactic
val cut_replacing               : 
  identifier -> impl -> types -> (tactic -> tactic) -> tactic
val cut_in_parallel             : impl list -> constr list -> tactic

val assert_as : bool -> intro_pattern_expr -> impl -> constr -> tactic
val forward   : tactic option -> intro_pattern_expr -> constr -> tactic

val true_cut                    : name -> impl -> constr -> tactic
val letin_tac                   : bool -> name -> impl -> constr -> clause -> tactic
val assert_tac                  : bool -> name -> impl -> constr -> tactic
val generalize                  : constr list -> impl list -> tactic
val generalize_dep              : impl -> constr  -> tactic
