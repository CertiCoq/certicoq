...
Proof.
intros U R; red in |- *.
intros x y H'; elim H' using Rplus_ind'.
...
Proof.
intros U R H'; red in |- *.
intros x y H'0; elim H'0 using Rstar_ind'; auto with sets.
...
Proof.
unfold contains in |- *.
intros U R S H' x y H'0; elim H'0 using Rstar_ind'; auto with sets.
generalize Rstar_transitive; intro T1; red in T1.
...
Theorem Lemma1 :
 forall (U:Type) (R:Relation U),
   ...
   forall x b:U,
     Rstar U R x b ->
     forall a:U, R x a ->  exists z, Rstar U R a z /\ R b z.
Proof.
intros U R H' x b H'0; elim H'0 using Rstar_ind'.
