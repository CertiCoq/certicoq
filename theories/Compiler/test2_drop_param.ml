...
let test2_L5 =
  Ret
    ...
    0) } :: [])) } :: [])) :: []))), (Oterm (CRet, ((Bterm ([], (Oterm (CKLambda,
    ...
    ('k'::[])))))) :: ((Bterm ([], (Oterm (CLambda, ((Bterm (((((fun p->2*p) 1), (NNamed
    ('T'::('o'::('p'::('#'::('T'::('E'::('S'::('T'::('_'::('L'::('6'::('#'::('e'::('v'::('e'::('n'::[])))))))))))))))))) :: ((((fun p->1+2*p)
    1), (NNamed ('k'::[]))) :: [])), (Oterm (CRet, ((Bterm ([], (Oterm (CKLambda,
    ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []), (Oterm (CRet, ((Bterm
    ([], (Vterm (((fun p->1+2*p) 1), (NNamed ('k'::[])))))) :: ((Bterm ([], (Vterm
    (((fun p->2*p) 1), (NNamed
    ('T'::('o'::('p'::('#'::('T'::('E'::('S'::('T'::('_'::('L'::('6'::('#'::('e'::('v'::('e'::('n'::[]))))))))))))))))))))) :: [])))))) :: []))))) :: ((Bterm
    ...
    (Oterm ((CFix ((Pervasives.succ (Pervasives.succ 0)), 0)), ((Bterm (((((fun p->2*p)
    1), (NNamed ('e'::('v'::('e'::('n'::[])))))) :: ((((fun p->2*p) ((fun p->2*p) 1)),
    (NNamed ('o'::('d'::('d'::[]))))) :: [])), (Oterm (CLambda, ((Bterm (((((fun p->2*p)
    ((fun p->1+2*p) 1)), (NNamed ('x'::[]))) :: ((((fun p->1+2*p) 1), (NNamed
    ...
    (((((fun p->2*p) ((fun p->2*p) ((fun p->2*p) 1))), (NNamed
    ('y'::[]))) :: ((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: [])), (Oterm (CRet,
    ((Bterm ([], (Oterm (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed
    ('k'::[]))) :: []), (Oterm (CRet, ((Bterm ([], (Oterm (CKLambda, ((Bterm
    (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []), (Oterm (CRet, ((Bterm ([], (Vterm
    (((fun p->1+2*p) 1), (NNamed ('k'::[])))))) :: ((Bterm ([], (Vterm (((fun p->2*p)
    ((fun p->1+2*p) 1)), (NNamed ('x'::[])))))) :: [])))))) :: []))))) :: ((Bterm ([],
    ...
    (NNamed ('k'::[])))))) :: ((Bterm ([], (Oterm ((CDCon (({ inductive_mind =
    ('C'::('o'::('q'::('.'::('I'::('n'::('i'::('t'::('.'::('D'::('a'::('t'::('a'::('t'::('y'::('p'::('e'::('s'::('.'::('b'::('o'::('o'::('l'::[])))))))))))))))))))))));
    inductive_ind = 0 }, 0), 0)), [])))) :: [])))))) :: []))))) :: ((Bterm ([], (Vterm
    (((fun p->1+2*p) 1), (NNamed ('k'::[])))))) :: [])))))) :: ((Bterm (((((fun p->2*p)
    ((fun p->1+2*p) ((fun p->2*p) 1))), NAnon) :: []), (Oterm (CRet, ((Bterm ([], (Oterm
    (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []), (Oterm (CRet,
    ((Bterm ([], (Oterm (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed
    ('k'::[]))) :: []), (Oterm (CRet, ((Bterm ([], (Vterm (((fun p->1+2*p) 1), (NNamed
    ('k'::[])))))) :: ((Bterm ([], (Oterm (CLambda, ((Bterm (((((fun p->2*p)
    ((fun p->2*p) ((fun p->1+2*p) 1))), (NNamed ('x'::('\''::[])))) :: ((((fun p->1+2*p)
    1), (NNamed ('k'::[]))) :: [])), (Oterm (CRet, ((Bterm ([], (Oterm (CKLambda,
    ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []), (Oterm (CRet, ((Bterm
    ([], (Oterm (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []),
    (Oterm (CRet, ((Bterm ([], (Oterm (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed
    ('k'::[]))) :: []), (Oterm (CRet, ((Bterm ([], (Vterm (((fun p->1+2*p) 1), (NNamed
    ('k'::[])))))) :: ((Bterm ([], (Vterm (((fun p->2*p) ((fun p->2*p) 1)), (NNamed
    ('o'::('d'::('d'::[])))))))) :: [])))))) :: []))))) :: ((Bterm ([], (Oterm
    (CKLambda, ((Bterm (((((fun p->1+2*p) ((fun p->2*p) 1)), (NNamed
    ('k'::('a'::('p'::('f'::[])))))) :: []), (Oterm (CRet, ((Bterm ([], (Oterm
    (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []), (Oterm (CRet,
    ((Bterm ([], (Vterm (((fun p->1+2*p) 1), (NNamed ('k'::[])))))) :: ((Bterm ([],
    (Vterm (((fun p->2*p) ((fun p->2*p) ((fun p->1+2*p) 1))), (NNamed
    ...
    (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []), (Oterm (CRet,
    ((Bterm ([], (Vterm (((fun p->1+2*p) 1), (NNamed ('k'::[])))))) :: ((Bterm ([],
    (Vterm (((fun p->2*p) ((fun p->2*p) ((fun p->2*p) 1))), (NNamed
    ('y'::[])))))) :: [])))))) :: []))))) :: ((Bterm ([], (Oterm (CKLambda, ((Bterm
    ...
    (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []), (Oterm (CRet,
    ((Bterm ([], (Vterm (((fun p->1+2*p) 1), (NNamed ('k'::[])))))) :: ((Bterm ([],
    (Vterm (((fun p->2*p) ((fun p->1+2*p) ((fun p->2*p) 1))),
    ...
    (((((fun p->2*p) 1), (NNamed ('e'::('v'::('e'::('n'::[])))))) :: ((((fun p->2*p)
    ((fun p->2*p) 1)), (NNamed ('o'::('d'::('d'::[]))))) :: [])), (Oterm (CLambda,
    ((Bterm (((((fun p->2*p) ((fun p->1+2*p) 1)), (NNamed
    ('x'::[]))) :: ((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: [])), (Oterm (CRet,
    ((Bterm ([], (Oterm (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed
    ('k'::[]))) :: []), (Oterm (CRet, ((Bterm ([], (Vterm (((fun p->1+2*p) 1), (NNamed
    ('k'::[])))))) :: ((Bterm ([], (Oterm (CLambda, ((Bterm (((((fun p->2*p)
    ((fun p->2*p) ((fun p->2*p) 1))), (NNamed ('y'::[]))) :: ((((fun p->1+2*p) 1),
    ...
    (NNamed ('k'::[])))))) :: ((Bterm ([], (Oterm ((CDCon (({ inductive_mind =
    ('C'::('o'::('q'::('.'::('I'::('n'::('i'::('t'::('.'::('D'::('a'::('t'::('a'::('t'::('y'::('p'::('e'::('s'::('.'::('b'::('o'::('o'::('l'::[])))))))))))))))))))))));
    inductive_ind = 0 }, 1), 0)), [])))) :: [])))))) :: []))))) :: ((Bterm ([], (Vterm
    (((fun p->1+2*p) 1), (NNamed ('k'::[])))))) :: [])))))) :: ((Bterm (((((fun p->2*p)
    ((fun p->1+2*p) ((fun p->2*p) 1))), NAnon) :: []), (Oterm (CRet, ((Bterm ([], (Oterm
    (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed ('k'::[]))) :: []), (Oterm (CRet,
    ((Bterm ([], (Oterm (CKLambda, ((Bterm (((((fun p->1+2*p) 1), (NNamed
