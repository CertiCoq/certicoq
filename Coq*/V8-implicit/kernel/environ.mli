...
(*i $Id: environ.mli 9821 2007-05-11 17:00:58Z aspiwack $ i*)
...
val set_impl_named_val : impl -> named_context_val -> named_context_val
...
(* Check that a term does not use implicit variable illegally *)
val noccur_implicit : named_context_val -> constr -> bool
val noccur_implicit_env : env -> constr -> bool
