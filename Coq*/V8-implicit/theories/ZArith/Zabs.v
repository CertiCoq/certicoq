...
(************************************************************************)
(*i $Id: Zabs.v 10028 2007-07-18 22:38:06Z letouzey $ i*)
...
Proof.
  ...
  assert (x <= 0). apply impl_PI; apply Zlt_le_weak; assumption.
  rewrite Zabs_non_eq. apply H0. assumption. assumption.
  rewrite Zabs_eq. apply H; apply impl_PI; assumption.
  apply impl_PI; apply Zge_le. assumption.
Qed.
