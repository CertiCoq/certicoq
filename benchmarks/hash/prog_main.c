...
extern value alloc_make_CertiRocq_Benchmarks_hash_hash_IO_Types_Build_IO_Types(struct thread_info *, value);
extern value alloc_make_CertiRocq_Benchmarks_hash_hash_IO_Impl_Build_IO_Impl(struct thread_info *, value, value);
extern value alloc_make_CertiRocq_Benchmarks_hash_hash_StringFFI_Build_StringFFI(struct thread_info *, value, value);
extern value alloc_make_CertiRocq_Benchmarks_hash_hash_Hash_Types_Build_Hash_Types(struct thread_info *, value);
extern value alloc_make_CertiRocq_Benchmarks_hash_hash_HashFFI_Build_HashFFI(struct thread_info *, value, value, value, value);
...
// with significant modifications to make it work on CertiRocq values
enum {SIZE = 109};
...
int main(int argc, char *argv[]) {
  ...
  value io_types = alloc_make_CertiRocq_Benchmarks_hash_hash_IO_Types_Build_IO_Types(tinfo, 1);

  value io_impl = alloc_make_CertiRocq_Benchmarks_hash_hash_IO_Impl_Build_IO_Impl(tinfo, io_ret_clo, io_bind_clo);

  value string_ffi =
    alloc_make_CertiRocq_Benchmarks_hash_hash_StringFFI_Build_StringFFI(
        tinfo,
        print_string_clo,
        scan_string_clo);

  // Types are dummy values
  value hash_types = alloc_make_CertiRocq_Benchmarks_hash_hash_Hash_Types_Build_Hash_Types(tinfo, 1);

  // TODO these functions don't handle garbage collection yet.
  value hash_ffi =
    alloc_make_CertiRocq_Benchmarks_hash_hash_HashFFI_Build_HashFFI(
        tinfo,
        new_clo,
        lookup_clo,
        insert_clo,
