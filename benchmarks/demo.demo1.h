...
extern unsigned int make_nat_S(unsigned int, unsigned int **);

extern unsigned int make_nat_O(void);

extern signed char const names_of_nat[2][2];

extern int const arities_of_nat[2];

extern void elim_nat(unsigned int, unsigned int *, unsigned int **);
