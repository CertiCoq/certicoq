...
val find_rectype     : env -> types -> inductive * constr list * impl list
val find_inductive   : env -> types -> inductive * constr list * impl list
val find_coinductive : env -> types -> inductive * constr list * impl list
...
val mind_arity :
  one_inductive_body -> Sign.rel_context * sorts_family
