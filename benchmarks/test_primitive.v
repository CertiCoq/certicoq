...
CertiRocq Eval -time -debug -typed-erasure testmul.
(*
...
CertiRocq Eval -time -typed-erasure -unsafe-erasure cst_small. (* Execution: 0.001s *)
CertiRocq Show IR -time -typed-erasure -unsafe-erasure cst_small. (* Execution: 0.001s *)

From Stdlib Require Import StreamMemo.

CertiRocq Show IR -time -typed-erasure -unsafe-erasure memo_make. (* Execution: 0.001s *)
...
(*CertiRocq Eval -time -typed-erasure -unsafe-erasure cst_big.*) (* Execution: 0.001s, slow compilation *)
(* CertiRocq Eval -time -unsafe-erasure cst_big. *)
...
(* Time CertiRocq Eval -debug -time -typed-erasure -unsafe-erasure cst_big2. *)
 (* 69s *)
