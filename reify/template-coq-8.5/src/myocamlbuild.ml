let coq_config_string = "LOCAL=1|COQLIB=/home/mdenes/coq.trunk/|DOCDIR=/|OCAMLDEP=ocamldep|OCAMLC=ocamlc|OCAMLOPT=ocamlopt|OCAMLDOC=ocamldoc|CAMLBIN=/home/mdenes/.opam/4.01.0/bin/|CAMLLIB=/home/mdenes/.opam/4.01.0/lib/ocaml/|CAMLP4=camlp5|CAMLP4O=camlp5o|CAMLP4BIN=/home/mdenes/.opam/4.01.0/bin/|CAMLP4LIB=/home/mdenes/.opam/4.01.0/lib/camlp5|CAMLP4OPTIONS=-loc loc|HASNATDYNLINK=true|";; 
...
let add_coq x =
  ...
  | After_rules ->
	...
	Cmd (S[A (Lazy.force camlpX ^ "o");
	       ...
	       A"-I";A (coq_dir "parsing");A"-I";A (coq_dir "grammar");
	       A"-threads";A"pa_extend.cmo";A"pa_macro.cmo";A"q_MLast.cmo";A"grammar.cma";
	       A"-loc";A"loc";
