...
Quote Definition qlist := Eval compute in xlist.
Print qlist.
...
Definition vplus (n:nat) :
  ...
  Eval cbv delta beta in (Vector.map2 plus).
...
Eval compute in ack 3 5.
Definition ack35 := (ack 3 5).
Quote Recursively Definition p_ack35 := ack35.
Eval compute in (program_Program p_ack35 (Ret nil)).
Quote Definition q_ack35 := Eval compute in ack35.
...
Eval compute in (program_Program p_pierce (Ret nil)).
...
Eval compute in (program_Program p_sherwood_size (Ret nil)).
