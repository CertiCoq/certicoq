...
val term_rect :
  (nat -> 'a1) -> (ident -> 'a1) -> (nat -> 'a1) -> (nat -> term list -> 'a1)
  -> (universe -> 'a1) -> (term -> 'a1 -> cast_kind -> term -> 'a1 -> 'a1) ->
  (name -> term -> 'a1 -> term -> 'a1 -> 'a1) -> (name -> term -> 'a1 -> term
  -> 'a1 -> 'a1) -> (name -> term -> 'a1 -> term -> 'a1 -> term -> 'a1 ->
  'a1) -> (term -> 'a1 -> term list -> 'a1) -> (kername -> universe_instance
  -> 'a1) -> (inductive -> universe_instance -> 'a1) -> (inductive -> nat ->
  universe_instance -> 'a1) -> ((inductive * nat) -> term -> 'a1 -> term ->
  'a1 -> (nat * term) list -> 'a1) -> (projection -> term -> 'a1 -> 'a1) ->
