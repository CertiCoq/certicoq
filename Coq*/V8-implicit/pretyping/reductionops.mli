...
(*i $Id: reductionops.mli 9850 2007-05-22 21:37:55Z herbelin $ i*)
...
val append_stack : 'a array -> impl array -> 'a stack -> 'a stack
val append_stack_list : 'a list -> impl list -> 'a stack -> 'a stack

val decomp_stack : 'a stack -> ('a * impl * 'a stack) option
val list_of_stack : 'a stack -> 'a list * impl list
val array_of_stack : 'a stack -> 'a array * impl array
...
val stack_nth : 'a stack -> int -> 'a * impl
...
val beta_applist : constr * constr list * impl list -> constr
...
val splay_prod :
  env ->  evar_map -> constr -> (name * impl * constr) list * constr
val splay_lambda :
  env ->  evar_map -> constr -> (name * impl * constr) list * constr
val splay_arity :
  env ->  evar_map -> constr -> (name * impl * constr) list * sorts
