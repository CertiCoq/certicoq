#ifndef CERTICOQ_BENCHMARKS_TESTS_LIST_SUM_C
#define CERTICOQ_BENCHMARKS_TESTS_LIST_SUM_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Benchmarks.tests.list_sum.h"
extern struct thread_info *make_tinfo(void);
extern value add_uncurried_103(struct thread_info *, value, value);
extern value fold_left_uncurried_102(struct thread_info *, value, value);
extern value repeat_uncurried_101(struct thread_info *, value, value);
extern value body(struct thread_info *);
value add_uncurried_103(struct thread_info *, value, value);
value fold_left_uncurried_102(struct thread_info *, value, value);
value repeat_uncurried_101(struct thread_info *, value, value);
value body(struct thread_info *);
unsigned long long const body_info_235[2] = { 202LL, 0LL, };

unsigned long long const repeat_uncurried_info_234[4] = { 0LL, 2LL, 0LL, 1LL,
  };

unsigned long long const fold_left_uncurried_info_233[4] = { 0LL, 2LL, 0LL,
  1LL, };

unsigned long long const add_uncurried_info_232[4] = { 0LL, 2LL, 0LL, 1LL, };

value add_uncurried_103(struct thread_info *$tinfo, value $m_119, value $n_120)
{
  ...
  if (($n_120 & 1) == 0) {
    switch (*((value *) $n_120 + -1LL) & 255LL) {
      default:
        ...
        /*skip*/;
        $y_122 =
          ((value (*)(struct thread_info *, value, value)) add_uncurried_103)
          ($tinfo, $m_119, $p_121);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        if (!(2LL <= $limit - $alloc)) {
...
value fold_left_uncurried_102(struct thread_info *$tinfo, value $a0_112, value $l_113)
{
  struct stack_frame frame;
  value root[2];
    ...
    switch (*((value *) $l_113 + -1LL) & 255LL) {
      default:
        ...
        *(root + 0LL) = $t_115;
        ...
        (*$tinfo).limit = $limit;
        $result =
          ((value (*)(struct thread_info *, value, value)) fold_left_uncurried_102)
          ($tinfo, $y_117, $t_115);
        return $result;
        break;
...
value repeat_uncurried_101(struct thread_info *$tinfo, value $n_105, value $x_106)
{
  struct stack_frame frame;
  value root[2];
    ...
    switch (*((value *) $n_105 + -1LL) & 255LL) {
      default:
        ...
        *(root + 0LL) = $x_106;
        ...
        (*$tinfo).fp = &frame;
        $y_109 =
          ((value (*)(struct thread_info *, value, value)) repeat_uncurried_101)
          ($tinfo, $k_108, $x_106);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        if (!(3LL <= $limit - $alloc)) {
...
#endif /* CERTICOQ_BENCHMARKS_TESTS_LIST_SUM_C */
