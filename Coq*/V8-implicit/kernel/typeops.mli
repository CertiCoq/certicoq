...
val judge_of_apply : 
  env -> unsafe_judgment -> unsafe_judgment array -> impl array
    -> unsafe_judgment * constraints

(*s Type of an abstraction. *)
val judge_of_abstraction : 
  env -> name -> impl -> unsafe_type_judgment -> unsafe_judgment 
    -> unsafe_judgment

(*s Type of a product. *)
val judge_of_product :
  env -> name -> impl -> unsafe_type_judgment -> unsafe_type_judgment 
    -> unsafe_judgment

(* s Type of a let in. *)
val judge_of_letin :
  env -> name -> impl -> unsafe_judgment -> unsafe_type_judgment -> unsafe_judgment 
    -> unsafe_judgment
