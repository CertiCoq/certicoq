...
Proof.
  ...
  unfold Rabs in |- *;
    ...
    (Rcase_abs
      ((f (c + Rmin (delta / 2) ((b + - c) / 2)) + - f c) /
        Rmin (delta / 2) ((b + - c) / 2) + - l)); intro; apply impl_PI.
  replace
  (-
    ((f (c + Rmin (delta / 2) ((b + - c) / 2)) + - f c) /
  ...
  unfold Rabs in |- *;
    ...
    (Rcase_abs
      ((f (c + Rmax (- (delta / 2)) ((a + - c) / 2)) + - f c) /
        Rmax (- (delta / 2)) ((a + - c) / 2) + - l)); intro; apply impl_PI.
  elim
      (Rlt_irrefl 0
        (Rlt_trans 0
          ((f (c + Rmax (- (delta / 2)) ((a + - c) / 2)) + - f c) /
  ...
  assumption.
  unfold Rabs in |- *;
 case (Rcase_abs (Rmax (- (delta / 2)) ((a - c) / 2)));
   intro; apply impl_PI.
...
Proof.
  ...
  intro; unfold Rabs in |- *;
    case (Rcase_abs ((f (x + delta / 2) - f x) / (delta / 2) - l)); intro; apply impl_PI.
  elim
      (Rlt_irrefl 0
