#ifndef CERTICOQ_BENCHMARKS_TESTS_DEMO2_C
#define CERTICOQ_BENCHMARKS_TESTS_DEMO2_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Benchmarks.tests.demo2.h"
extern struct thread_info *make_tinfo(void);
extern value f_case_103(struct thread_info *, value);
extern value map_102(struct thread_info *, value);
extern value repeat2_uncurried_uncurried_uncurried_101(struct thread_info *, value, value, value);
extern value body(struct thread_info *);
value f_case_103(struct thread_info *, value);
value map_102(struct thread_info *, value);
value repeat2_uncurried_uncurried_uncurried_101(struct thread_info *, value, value, value);
value body(struct thread_info *);
unsigned long long const body_info_239[2] = { 200LL, 0LL, };

unsigned long long const repeat2_uncurried_uncurried_uncurried_info_238[5] = {
  0LL, 3LL, 0LL, 1LL, 2LL, };

unsigned long long const map_info_237[3] = { 0LL, 1LL, 0LL, };

unsigned long long const f_case_info_236[3] = { 0LL, 1LL, 0LL, };

value f_case_103(struct thread_info *$tinfo, value $s_125)
{
...
value map_102(struct thread_info *$tinfo, value $l_116)
{
  struct stack_frame frame;
  value root[2];
    ...
    switch (*((value *) $l_116 + -1LL) & 255LL) {
      default:
        ...
        *(root + 0LL) = $t_119;
        ...
        (*$tinfo).fp = &frame;
        $y_121 =
          ((value (*)(struct thread_info *, value)) f_case_103)
          ($tinfo, $a_118);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        $t_119 = *(root + 0LL);
        ...
        *(root + 0LL) = $y_121;
        ...
        (*$tinfo).fp = &frame;
        $y_122 =
          ((value (*)(struct thread_info *, value)) map_102)
          ($tinfo, $t_119);
        $alloc = (*$tinfo).alloc;
        $limit = (*$tinfo).limit;
        if (!(3LL <= $limit - $alloc)) {
...
value repeat2_uncurried_uncurried_uncurried_101(struct thread_info *$tinfo, value $n_105, value $y_106, value $x_107)
{
  struct stack_frame frame;
  value root[3];
    ...
    switch (*((value *) $n_105 + -1LL) & 255LL) {
      default:
        ...
        *(root + 0LL) = $y_106;
        ...
        (*$tinfo).fp = &frame;
        $y_112 =
          ((value (*)(struct thread_info *, value, value, value)) repeat2_uncurried_uncurried_uncurried_101)
...
#endif /* CERTICOQ_BENCHMARKS_TESTS_DEMO2_C */
