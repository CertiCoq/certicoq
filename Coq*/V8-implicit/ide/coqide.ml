...
(* $Id: coqide.ml 9796 2007-04-26 08:54:28Z corbinea $ *)
...
let create_input_tab filename =
  ...
  let appendp ~tab_label x = ignore ((notebook())#append_page ~tab_label x) in
  let fr1 = GBin.frame ~shadow_type:`ETCHED_OUT
    ~packing:(appendp ~tab_label:v_box#coerce) () 
  in 
