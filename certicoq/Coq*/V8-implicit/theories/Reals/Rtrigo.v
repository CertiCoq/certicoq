...
Proof.
  intro; case (Rle_dec (-1) (sin x)); intro; apply impl_PI.
  case (Rle_dec (sin x) 1); intro; apply impl_PI.
  split; assumption.
  cut (1 < sin x).
  intro;
    generalize
...
Proof.
  ...
  rewrite Rmult_0_r. 
  clear H6; intro H6; case (Rcase_abs (sin ((x - y) / 2))); intro H7; apply impl_PI.
  assumption.
...
Proof.
  ...
  discrR.
  reflexivity.
  case (Rcase_abs (sin (x - y))); intro H9; apply impl_PI.
  assumption.
