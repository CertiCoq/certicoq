...
(*i $Id: PermutSetoid.v 9913 2007-06-27 01:50:17Z letouzey $ i*)
...
Proof.
  ...
  split; intros.
  inversion_clear H.
  destruct (eqA_dec a a0) as [_|H1]; apply impl_PI; auto with arith.
  destruct H1; auto.
  destruct (eqA_dec a a0); apply impl_PI; auto with arith.
  simpl; rewrite <- IHl; auto.
  destruct (eqA_dec a a0) as [H0|H0]; apply impl_PI; auto.
  simpl in H.
...
Proof.
  ...
  inversion_clear 1.
  rewrite IHl in H1.
  intros; destruct (eqA_dec a a0) as [H2|H2]; apply impl_PI; simpl; auto.
  ...
  generalize (H a).
  destruct (eqA_dec a a) as [H0|H0]; apply impl_PI.
  destruct (multiplicity (list_contents l) a); auto with arith.
  simpl; inversion 1. 
  inversion H3.
  destruct H0; auto.
...
Proof.
  ...
  destruct (eqA_dec b b) as [H|H]; apply impl_PI; [ | destruct H; auto].
  destruct (eqA_dec a b); apply impl_PI; simpl; auto; intros; discriminate.
Qed.
...
Proof.
  ...
  destruct (eqA_dec a1 a) as [H2|H2]; 
    destruct (eqA_dec a2 a) as [H3|H3]; apply impl_PI; auto.
  ...
  generalize (P a); clear P; simpl.
  destruct (eqA_dec a1 a) as [H2|H2]; 
    destruct (eqA_dec b2 a) as [H3|H3]; apply impl_PI; auto.
...
Proof.
  ...
  destruct (eqA_dec b a0) as [H2|H2]; 
    destruct (eqA_dec a a0) as [H3|H3]; apply impl_PI; auto.
...
Proof.
  ...
  destruct (eqB_dec (f b) a0) as [H2|H2]; 
    destruct (eqB_dec (f a) a0) as [H3|H3]; apply impl_PI; auto.
