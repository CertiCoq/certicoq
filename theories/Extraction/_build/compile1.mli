...
val coq_Term_rect :
  ...
  -> 'a1 -> 'a1) -> (char list -> 'a1) -> (inductive -> nat -> coq_Terms ->
  'a1) -> (inductive -> coq_Term -> 'a1 -> coq_Brs -> 'a1) -> (coq_Defs ->
  nat -> 'a1) -> (projection -> coq_Term -> 'a1 -> 'a1) -> (char list -> 'a1)
  -> coq_Term -> 'a1
...
val coq_R_lift_rect :
  ...
  coq_Term -> projection -> coq_Term -> __ -> coq_Term -> coq_R_lift -> 'a1
  -> 'a1) -> (nat -> coq_Term -> coq_Term -> __ -> __ -> 'a1) -> nat ->
  coq_Term -> coq_Term -> coq_R_lift -> 'a1
...
val lift_rect :
  ...
  projection -> coq_Term -> __ -> 'a1 -> 'a1) -> (nat -> coq_Term -> coq_Term
  -> __ -> __ -> 'a1) -> nat -> coq_Term -> 'a1
...
val coq_R_etaExpand_args_Lam'_rect :
  ...
  coq_R_etaExpand_args_Lam' -> 'a1 -> 'a1) -> nat -> (coq_Terms -> coq_Term)
  -> coq_Terms -> coq_Term -> coq_R_etaExpand_args_Lam' -> 'a1
...
val coq_R_etaExpand_args_Lam_rect :
  ...
  (coq_Terms -> coq_Term) -> coq_Terms -> nat -> __ -> coq_Term -> coq_Terms
  -> __ -> coq_Term -> coq_R_etaExpand_args_Lam -> 'a1 -> 'a1) -> nat ->
  coq_Terms -> (coq_Terms -> coq_Term) -> coq_Terms -> coq_Term ->
...
val etaExpand_args_Lam_rect :
  ...
  coq_Term) -> coq_Terms -> nat -> __ -> __ -> 'a1) -> (nat -> coq_Terms ->
  (coq_Terms -> coq_Term) -> coq_Terms -> nat -> __ -> coq_Term -> coq_Terms
  -> __ -> 'a1 -> 'a1) -> nat -> coq_Terms -> (coq_Terms -> coq_Term) ->
  coq_Terms -> 'a1
...
val coq_R_nLambda_rect :
  (nat -> coq_Term -> __ -> 'a1) -> (nat -> coq_Term -> nat -> __ -> coq_Term
  -> coq_R_nLambda -> 'a1 -> 'a1) -> nat -> coq_Term -> coq_Term ->
  coq_R_nLambda -> 'a1
...
val coq_R_Lambdan_rect :
  (nat -> coq_Term -> __ -> 'a1) -> (nat -> coq_Term -> nat -> __ -> coq_Term
  -> coq_R_Lambdan -> 'a1 -> 'a1) -> nat -> coq_Term -> coq_Term ->
  coq_R_Lambdan -> 'a1
...
val etaExpand_aArgs :
  (coq_Terms -> coq_Term) -> nat -> nat -> coq_Terms -> coq_Terms -> coq_Term
...
val coq_R_etaExpand_aArgs_rect :
  ...
  coq_Terms -> __ -> 'a1) -> (nat -> nat -> coq_Terms -> coq_Terms -> nat ->
  __ -> __ -> 'a1) -> nat -> nat -> coq_Terms -> coq_Terms -> coq_Term ->
  coq_R_etaExpand_aArgs -> 'a1
...
val etaExpand_aArgs_rect :
  ...
  coq_Terms -> coq_Terms -> __ -> coq_Term -> coq_Terms -> __ -> 'a1) -> (nat
  -> nat -> coq_Terms -> coq_Terms -> nat -> __ -> __ -> 'a1) -> nat -> nat
  -> coq_Terms -> coq_Terms -> 'a1
...
val coq_R_etaExpand_aArgs_correct :
  (coq_Terms -> coq_Term) -> nat -> nat -> coq_Terms -> coq_Terms -> coq_Term
  -> coq_R_etaExpand_aArgs

val etaExpand : (coq_Terms -> coq_Term) -> coq_Terms -> nat -> nat -> coq_Term
...
val coq_R_etaExpand_rect :
  ...
  coq_Terms -> __ -> nat -> __ -> coq_Term -> coq_R_etaExpand -> 'a1 -> 'a1)
  -> (coq_Terms -> nat -> nat -> __ -> nat -> __ -> 'a1) -> (coq_Terms -> nat
  -> nat -> coq_Terms -> __ -> __ -> __ -> 'a1) -> coq_Terms -> nat -> nat ->
  coq_Term -> coq_R_etaExpand -> 'a1
...
val coq_R_strip_rect :
  ...
  (coq_L1gTerm -> name -> Compile0.coq_Term -> __ -> coq_Term -> coq_R_strip
  -> 'a1 -> 'a1) -> (coq_L1gTerm -> name -> Compile0.coq_Term ->
  Compile0.coq_Term -> __ -> coq_Term -> coq_R_strip -> 'a1 -> coq_Term ->
  coq_R_strip -> 'a1 -> 'a1) -> (coq_L1gTerm -> Compile0.coq_Term ->
  Compile0.coq_Term -> __ -> coq_Term -> coq_R_strip -> 'a1 -> __ -> coq_Term
  -> coq_R_strip -> 'a1 -> 'a1) -> (coq_L1gTerm -> Compile0.coq_Term ->
  Compile0.coq_Term -> __ -> coq_Term -> coq_R_strip -> 'a1 -> (coq_Terms ->
  ...
  Compile0.coq_Brs -> __ -> coq_Term -> coq_R_strip -> 'a1 -> coq_Brs ->
  coq_R_stripBs -> 'a1) -> (coq_L1gTerm -> Compile0.coq_Defs -> nat -> __ ->
  coq_Defs -> coq_R_stripDs -> 'a1) -> (coq_L1gTerm -> inductive -> nat ->
  nat -> Compile0.coq_Term -> __ -> coq_Term -> coq_R_strip -> 'a1 -> 'a1) ->
...
val coq_R_stripDs_rect :
  ...
  coq_R_stripDs -> 'a1 -> 'a1) -> coq_L1gDefs -> coq_Defs -> coq_R_stripDs ->
  'a1
...
val strip_rect :
  ...
  (coq_L1gTerm -> name -> Compile0.coq_Term -> Compile0.coq_Term -> __ -> 'a1
  -> 'a1 -> 'a1) -> (coq_L1gTerm -> Compile0.coq_Term -> Compile0.coq_Term ->
  __ -> 'a1 -> __ -> 'a1 -> 'a1) -> (coq_L1gTerm -> Compile0.coq_Term ->
  Compile0.coq_Term -> __ -> 'a1 -> (coq_Terms -> coq_Term) -> coq_Terms ->
  nat -> nat -> __ -> 'a1) -> (coq_L1gTerm -> char list -> __ -> 'a1) ->
  (coq_L1gTerm -> inductive -> nat -> nat -> nat -> __ -> 'a1) ->
  (coq_L1gTerm -> (inductive * nat) -> Compile0.coq_Term -> Compile0.coq_Brs
  -> __ -> 'a1 -> 'a1) -> (coq_L1gTerm -> Compile0.coq_Defs -> nat -> __ ->
  'a1) -> (coq_L1gTerm -> inductive -> nat -> nat -> Compile0.coq_Term -> __
  -> 'a1 -> 'a1) -> (coq_L1gTerm -> char list -> __ -> 'a1) -> coq_L1gTerm ->
  'a1
