#ifndef CERTICOQ_TESTS_TESTS_REC_CLOS2_OPT2_C
#define CERTICOQ_TESTS_TESTS_REC_CLOS2_OPT2_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Tests.tests.rec_clos2_opt2.h"
...
unsigned long long const body_info_752[2] = { 1212LL, 0LL, };

unsigned long long const mul_uncurried_known_info_751[4] = { 0LL, 2LL, 0LL,
  1LL, };

unsigned long long const add_uncurried_known_info_750[4] = { 0LL, 2LL, 0LL,
  1LL, };

unsigned long long const repeat_uncurried_known_info_749[4] = { 0LL, 2LL,
  0LL, 1LL, };

unsigned long long const aux_uncurried_known_info_748[7] = { 12LL, 5LL, 0LL,
  1LL, 2LL, 3LL, 4LL, };

value aux_uncurried_known_104(struct thread_info *$tinfo, value $acc_121, value $l_122, value $y_123, value $y_124, value $y_125)
{
  struct stack_frame frame;
  value root[5];
  register value $z_126;
  register value $zs_127;
  ...
  if (($l_122 & 1) == 0) {
    switch (*((value *) $l_122 + -1LL) & 255LL) {
      default:
        $z_126 = *((value *) $l_122 + 0LL);
        $zs_127 = *((value *) $l_122 + 1LL);
        $y_128 = (value) ($alloc + 1LL);
        $alloc = $alloc + 3LL;
        *((value *) $y_128 + -1LL) = 2048LL;
        *((value *) $y_128 + 0LL) = $y_125;
        *((value *) $y_128 + 1LL) = $acc_121;
        $y_129 = (value) ($alloc + 1LL);
        $alloc = $alloc + 3LL;
        *((value *) $y_129 + -1LL) = 2048LL;
        *((value *) $y_129 + 0LL) = $y_124;
        *((value *) $y_129 + 1LL) = $y_128;
        $y_130 = (value) ($alloc + 1LL);
        $alloc = $alloc + 3LL;
        *((value *) $y_130 + -1LL) = 2048LL;
        *((value *) $y_130 + 0LL) = $y_123;
        *((value *) $y_130 + 1LL) = $y_129;
        $y_131 = (value) ($alloc + 1LL);
        $alloc = $alloc + 3LL;
        *((value *) $y_131 + -1LL) = 2048LL;
        *((value *) $y_131 + 0LL) = $z_126;
        *((value *) $y_131 + 1LL) = $y_130;
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        $result =
          ...
          ($tinfo, $y_131, $zs_127, $y_123, $y_124, $y_125);
        return $result;
        break;
...
value repeat_uncurried_known_103(struct thread_info *$tinfo, value $n_115, value $x_116)
{
  struct stack_frame frame;
  value root[2];
  register value $y_117;
  register value $k_118;
  ...
  frame.prev = (*$tinfo).fp;
  if (($n_115 & 1) == 0) {
    switch (*((value *) $n_115 + -1LL) & 255LL) {
      default:
        $k_118 = *((value *) $n_115 + 0LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 0LL) = $x_116;
        ...
        $alloc = $alloc + 3LL;
        *((value *) $y_120 + -1LL) = 2048LL;
        *((value *) $y_120 + 0LL) = $x_116;
        *((value *) $y_120 + 1LL) = $y_119;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        return $y_120;
        break;
...
value add_uncurried_known_102(struct thread_info *$tinfo, value $m_110, value $n_111)
{
  struct stack_frame frame;
  value root[2];
  register value $p_112;
...
value mul_uncurried_known_101(struct thread_info *$tinfo, value $m_105, value $n_106)
{
  struct stack_frame frame;
  value root[2];
  ...
  frame.prev = (*$tinfo).fp;
  if (($n_106 & 1) == 0) {
    switch (*((value *) $n_106 + -1LL) & 255LL) {
      default:
        $p_108 = *((value *) $n_106 + 0LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 0LL) = $m_105;
...
value body(struct thread_info *$tinfo)
{
  ...
  register value $CertiCoqdTestsdtestsdrec_clos2_747;
  register value *$alloc;
  register value *$limit;
  register value *$args;
  $alloc = (*$tinfo).alloc;
  ...
  *(root + 0LL) = $y_133;
  ...
  (*$tinfo).limit = $limit;
  /*skip*/;
  $CertiCoqdTestsdtestsdrec_clos2_747 =
    ((value (*)(struct thread_info *, value, value, value, value, value)) 
      aux_uncurried_known_104)
    ($tinfo, $y_746, $y_745, $y_133, $y_136, $y_140);
  $alloc = (*$tinfo).alloc;
  $limit = (*$tinfo).limit;
  /*skip*/;
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  return $CertiCoqdTestsdtestsdrec_clos2_747;
}


#endif /* CERTICOQ_TESTS_TESTS_REC_CLOS2_OPT2_C */
