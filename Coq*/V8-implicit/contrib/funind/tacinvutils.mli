...
val prod_it_lift:  (name*impl*constr) list -> constr -> constr
val prod_it_anonym_lift: constr -> constr list -> impl list -> constr
val lam_it_anonymous: constr -> constr list -> impl list -> constr
