...
(*i $Id: Eqdep_dec.v 9905 2007-06-21 17:51:01Z notin $ i*)
...
Proof.
  ...
  case (eq_dec x0 y); [left|right]; apply impl_PI; assumption.
  trivial.
Qed.
...
Module DecidableEqDep (M:DecidableType).
  ...
  Proof.
    ...
    intros x0 y0; case (eq_dec x0 y0); [left|right]; apply impl_PI; assumption.
    assumption.
  Qed.
