...
Section defs.
  ...
  Proof.
    ...
    elim (H3 a0); intros.
    apply insert_exist with (Tree_Node a T2 T0); apply impl_PI;
      auto using node_is_heap, nil_is_heap, leA_Tree_Leaf with datatypes.
    ...
    apply insert_exist with (Tree_Node a0 T2 T3); 
      auto using node_is_heap, nil_is_heap, leA_Tree_Leaf with datatypes.
    apply impl_PI; apply node_is_heap; auto using node_is_heap, nil_is_heap, leA_Tree_Leaf with datatypes.
