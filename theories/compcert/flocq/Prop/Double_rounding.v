...
- (* fexp1 (mag x) <= fexp2 (mag x) *)
  assert (Hf2'' : (fexp2 (mag x) = fexp1 (mag x) :> Z)%Z); [lia|].
  now apply round_round_lt_mid_same_place.
- (* fexp2 (mag x) < fexp1 (mag x) *)
  assert (Hf2'' : (fexp2 (mag x) <= fexp1 (mag x) - 1)%Z); [lia|].
...
- (* fexp1 (mag x) - 2 < mag y *)
  ...
  + reflexivity.
  + now apply valid_rnd_N.
  + assert (Hf1 : (fexp1 (mag x) - 1 <= mag y)%Z); [lia|].
  ...
  + (* mag y <= fexp1 (mag x) - 2 *)
    ...
    * (* fexp1 (mag (x - y)) - 2 < mag y *)
      { rewrite (round_generic beta fexp2).
        - reflexivity.
        - now apply valid_rnd_N.
        - assert (Hf1 : (fexp1 (mag (x - y)) - 1 <= mag y)%Z); [lia|].
...
- (* fexp1 (mag x) - 1 < mag y *)
  ...
  + reflexivity.
  + now apply valid_rnd_N.
  + assert (Hf1 : (fexp1 (mag x) <= mag y)%Z); [lia|].
  ...
  + (* mag y <= fexp1 (mag x) - 1 *)
    ...
    * (* fexp1 (mag (x - y)) - 1 < mag y *)
      { rewrite (round_generic beta fexp2).
        - reflexivity.
        - now apply valid_rnd_N.
        - assert (Hf1 : (fexp1 (mag (x - y)) <= mag y)%Z); [lia|].
...
- (* 0 < x *)
  ...
  { destruct (Rle_or_lt x 1) as [Hx|Hx].
    ...
    - (* 1 < x *)
      ...
      intro Hexp10.
      assert (Hf0 : (fexp1 1 < 1)%Z); [lia|clear Hexp10].
