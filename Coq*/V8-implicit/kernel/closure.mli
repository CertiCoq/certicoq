...
val append_stack : fconstr array -> impl array -> stack -> stack

val decomp_stack : stack -> (fconstr * stack) option
val array_of_stack : stack -> fconstr array * impl array
...
val destFLambda :
  (fconstr subs -> constr -> fconstr) -> fconstr ->
  name * impl * fconstr * fconstr
...
val kh : clos_infos -> fconstr -> stack -> fconstr
