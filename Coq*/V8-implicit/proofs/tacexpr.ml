...
(*i $Id: tacexpr.ml 9954 2007-07-06 16:35:07Z letouzey $ i*)
...
type ('constr,'pat,'cst,'ind,'ref,'id,'tac) gen_atomic_tactic_expr =
  ...
  | TacCut of Term.impl * 'constr
  | TacAssert of 'tac option * intro_pattern_expr * 'constr
  | TacGeneralize of Term.impl list * 'constr list
  | TacGeneralizeDep of Term.impl * 'constr
  | TacLetTac of name * Term.impl * 'constr * 'id gclause
