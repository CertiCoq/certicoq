...
/* extern struct Coq_Init_Datatypes_nat_args *get_Coq_Init_Datatypes_nat_args(unsigned long long); */
...
/*   while (tag != 0) { */
/*     cnt ++ ; */
/*     val = *((unsigned long long *)((get_Coq_Init_Datatypes_nat_args)(val)) + 0); */
/*     tag = (get_Coq_Init_Datatypes_nat_tag)(val); */
/*   } */
/*   printf("%d\n", cnt); */
/* } */
