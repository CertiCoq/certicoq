...
Definition ___builtin_bswap : AST.ident := 61%positive.
Definition ___builtin_bswap16 : AST.ident := 63%positive.
Definition ___builtin_bswap32 : AST.ident := 62%positive.
Definition ___builtin_clz : AST.ident := 64%positive.
Definition ___builtin_clzl : AST.ident := 65%positive.
Definition ___builtin_clzll : AST.ident := 66%positive.
Definition ___builtin_ctz : AST.ident := 67%positive.
Definition ___builtin_ctzl : AST.ident := 68%positive.
Definition ___builtin_ctzll : AST.ident := 69%positive.
Definition ___builtin_debug : AST.ident := 82%positive.
Definition ___builtin_fabs : AST.ident := 35%positive.
Definition ___builtin_fmadd : AST.ident := 73%positive.
Definition ___builtin_fmax : AST.ident := 71%positive.
Definition ___builtin_fmin : AST.ident := 72%positive.
Definition ___builtin_fmsub : AST.ident := 74%positive.
Definition ___builtin_fnmadd : AST.ident := 75%positive.
Definition ___builtin_fnmsub : AST.ident := 76%positive.
Definition ___builtin_fsqrt : AST.ident := 70%positive.
Definition ___builtin_membar : AST.ident := 39%positive.
Definition ___builtin_memcpy_aligned : AST.ident := 36%positive.
Definition ___builtin_nop : AST.ident := 81%positive.
Definition ___builtin_read16_reversed : AST.ident := 77%positive.
Definition ___builtin_read32_reversed : AST.ident := 78%positive.
Definition ___builtin_va_arg : AST.ident := 41%positive.
Definition ___builtin_va_copy : AST.ident := 42%positive.
Definition ___builtin_va_end : AST.ident := 43%positive.
Definition ___builtin_va_start : AST.ident := 40%positive.
Definition ___builtin_write16_reversed : AST.ident := 79%positive.
Definition ___builtin_write32_reversed : AST.ident := 80%positive.
Definition ___compcert_va_composite : AST.ident := 47%positive.
Definition ___compcert_va_float64 : AST.ident := 46%positive.
Definition ___compcert_va_int32 : AST.ident := 44%positive.
Definition ___compcert_va_int64 : AST.ident := 45%positive.
Definition ___i64_dtos : AST.ident := 48%positive.
Definition ___i64_dtou : AST.ident := 49%positive.
Definition ___i64_sar : AST.ident := 60%positive.
Definition ___i64_sdiv : AST.ident := 54%positive.
Definition ___i64_shl : AST.ident := 58%positive.
Definition ___i64_shr : AST.ident := 59%positive.
Definition ___i64_smod : AST.ident := 56%positive.
Definition ___i64_stod : AST.ident := 50%positive.
Definition ___i64_stof : AST.ident := 52%positive.
Definition ___i64_udiv : AST.ident := 55%positive.
Definition ___i64_umod : AST.ident := 57%positive.
Definition ___i64_utod : AST.ident := 51%positive.
Definition ___i64_utof : AST.ident := 53%positive.
Definition ___sFILE : AST.ident := 25%positive.
Definition ___sFILEX : AST.ident := 17%positive.
Definition ___sbuf : AST.ident := 3%positive.
Definition ___stderrp : AST.ident := 86%positive.
Definition ___stringlit_1 : AST.ident := 96%positive.
Definition ___stringlit_2 : AST.ident := 97%positive.
Definition ___stringlit_3 : AST.ident := 98%positive.
Definition ___stringlit_4 : AST.ident := 99%positive.
Definition ___stringlit_5 : AST.ident := 101%positive.
Definition __base : AST.ident := 1%positive.
Definition __bf : AST.ident := 9%positive.
Definition __blksize : AST.ident := 23%positive.
Definition __close : AST.ident := 12%positive.
Definition __cookie : AST.ident := 11%positive.
Definition __extra : AST.ident := 18%positive.
Definition __file : AST.ident := 8%positive.
Definition __flags : AST.ident := 7%positive.
Definition __lb : AST.ident := 22%positive.
Definition __lbfsize : AST.ident := 10%positive.
Definition __nbuf : AST.ident := 21%positive.
Definition __offset : AST.ident := 24%positive.
Definition __p : AST.ident := 4%positive.
Definition __r : AST.ident := 5%positive.
Definition __read : AST.ident := 13%positive.
Definition __seek : AST.ident := 14%positive.
Definition __size : AST.ident := 2%positive.
Definition __ub : AST.ident := 16%positive.
Definition __ubuf : AST.ident := 20%positive.
Definition __ur : AST.ident := 19%positive.
Definition __w : AST.ident := 6%positive.
Definition __write : AST.ident := 15%positive.
Definition _abort : AST.ident := 88%positive.
Definition _alloc : AST.ident := 28%positive.
Definition _argc : AST.ident := 27%positive.
Definition _args : AST.ident := 26%positive.
Definition _exit : AST.ident := 83%positive.
Definition _fi : AST.ident := 90%positive.
Definition _fprintf : AST.ident := 87%positive.
Definition _free : AST.ident := 84%positive.
Definition _free_heap : AST.ident := 103%positive.
Definition _garbage_collect : AST.ident := 102%positive.
Definition _gc : AST.ident := 105%positive.
Definition _h : AST.ident := 92%positive.
Definition _heap : AST.ident := 30%positive.
Definition _hi : AST.ident := 94%positive.
Definition _limit : AST.ident := 29%positive.
Definition _lo : AST.ident := 93%positive.
Definition _main : AST.ident := 106%positive.
Definition _malloc : AST.ident := 85%positive.
Definition _next : AST.ident := 33%positive.
Definition _num_allocs : AST.ident := 95%positive.
Definition _printf : AST.ident := 89%positive.
Definition _reset_heap : AST.ident := 104%positive.
Definition _resume : AST.ident := 100%positive.
Definition _space : AST.ident := 34%positive.
Definition _start : AST.ident := 32%positive.
Definition _thread_info : AST.ident := 31%positive.
Definition _ti : AST.ident := 91%positive.
Definition _t'1 : AST.ident := 107%positive.
Definition _t'2 : AST.ident := 108%positive.
Definition _t'3 : AST.ident := 109%positive.
