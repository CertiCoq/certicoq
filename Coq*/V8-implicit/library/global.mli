...
(*i $Id: global.mli 9821 2007-05-11 17:00:58Z aspiwack $ i*)
...
val push_named_assum : (identifier * impl * types) -> Univ.constraints
val push_named_def   :
  (identifier * impl * constr * types option) -> Univ.constraints
