...
Proof.
  intros. elim (Ndiscr (Nxor a a')).
  intro H1. elim H1. intros p H2. unfold Nless in |- *.
  rewrite (impl_PI H2). generalize (impl_PI H2). elim p. intros. simpl in |- *. rewrite H. rewrite H0. reflexivity.
  ...
  rewrite (impl_PI H1). reflexivity.
Qed.
...
Proof.
  ...
  rewrite H4. reflexivity.
  intro. simpl in |- *. rewrite H. rewrite H0. reflexivity.
  intro H1. unfold Nless in |- *. rewrite (impl_PI H1). reflexivity.
Qed.
