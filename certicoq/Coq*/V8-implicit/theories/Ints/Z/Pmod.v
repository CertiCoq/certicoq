...
Proof.
 ...
 induction Hacc using Acc_ind'; intros a Hle r Hmod.
...
Proof.
 ...
 destruct (Z_lt_le_dec a b); apply impl_PI.
...
Proof with mauto.
 intros a;assert (Hacc := Zwf_pos a);induction Hacc using Acc_ind';rename x into a;intros.
