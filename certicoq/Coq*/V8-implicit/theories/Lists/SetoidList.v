...
(* $Id: SetoidList.v 9914 2007-06-27 14:26:19Z letouzey $ *)
...
inversion_clear H; auto.
apply impl_PI; destruct H0; apply eqA_trans with a; auto.
split.
inversion_clear 1.
apply impl_PI; split; auto.
swap n.
...
destruct (eqA_dec a a'); apply impl_PI; intuition.
destruct (eqA_dec a a'); apply impl_PI; simpl.
destruct H0.
...
rewrite <- IHl; auto.
destruct (eqA_dec a a'); simpl in *; apply impl_PI.
