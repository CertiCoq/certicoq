...
Require Import cps eval cps_util identifiers env ctx Ensembles_util List_util.
...
Section Log_rel.
  ...
  Fixpoint preord_val (k : nat) (v1 v2 : val) {struct k} : Prop :=
    let preord_exp (k : nat) (p1 p2 : exp * env) : Prop :=
        ...
        let '(e2, rho2) := p2 in
        forall v1 c1,
           c1 <= k -> bstep_e pr rho1 e1 v1 c1 ->
           exists v2 c2, bstep_e pr rho2 e2 v2 c2 /\ 
