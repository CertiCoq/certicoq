...
Require Import ImplicitAxioms.
  ...
  Proof.
    ...
    rewrite <- Zeven.Zeven_div2; apply impl_PI; auto.
    
    generalize (Zeven.Zodd_div2 z H (impl_PI z0)); omega.
  Qed.
  ...
  Proof.
    ...
    rewrite (Zeven_bit_value z (impl_PI H)); intros; omega.

    rewrite (Zodd_bit_value z (impl_PI H)); intros; omega.
  Qed.
