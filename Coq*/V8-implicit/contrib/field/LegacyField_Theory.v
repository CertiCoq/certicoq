...
simpl in |- *; case (eqExprA EAzero (EAinv a)); intros; apply impl_PI;
 [ inversion e0 | simpl in |- *; trivial ].
simpl in |- *; case (eqExprA EAone (EAinv a)); intros; apply impl_PI;
 [ inversion e0 | simpl in |- *; trivial ].
simpl in |- *; case (eqExprA (EAplus e0 e1) (EAinv a)); intros; apply impl_PI;
 [ inversion e2 | simpl in |- *; trivial ].
simpl in |- *; case (eqExprA e0 (EAinv a)); intros; apply impl_PI.
...
simpl in |- *; fold AoppT in |- *; case (eqExprA (EAopp e0) (EAinv a));
 intros; apply impl_PI; [ inversion e1 | simpl in |- *; trivial ].
unfold monom_remove in |- *;
  case (eqExprA (EAinv e0) (EAinv a)); intros; apply impl_PI.
case (eqExprA e0 a); intros; apply impl_PI.
...
unfold monom_remove in |- *; case (eqExprA (EAvar n) (EAinv a)); intros;
 apply impl_PI; [ inversion e0 | simpl in |- *; trivial ].
Qed.
...
Proof.
simple induction e; intros; auto.
simpl in |- *; case (eqExprA a e0); intros; apply impl_PI.
