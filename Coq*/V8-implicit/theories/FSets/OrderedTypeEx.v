...
(* $Id: OrderedTypeEx.v 9883 2007-06-07 18:44:59Z letouzey $ *)
...
Module Type UsualOrderedType.
 ...
 Definition eq_refl := fun x:t => refl_equal x.
 Definition eq_sym := fun x y => @sym_eq t x y.
 Definition eq_trans := fun x y z => @trans_eq t x y z.
...
Module Nat_as_OT <: UsualOrderedType.
  ...
  Proof.
    ...
    constructor 1; apply impl_PI; auto.
    constructor 2; apply impl_PI; auto.
    intro; constructor 3; apply impl_PI; auto.
  Defined.
...
Module Z_as_OT <: UsualOrderedType.
  ...
  Definition t := Z.
  Definition eq := @eq Z. 
  Definition eq_refl (x:t) := refl_equal x.
