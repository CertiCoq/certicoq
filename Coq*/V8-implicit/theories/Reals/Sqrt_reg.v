...
Proof.
  ...
  destruct (total_order_or h 0) as [[a|b]|r].
...
Proof.
  ...
  left; apply H.
  elim H6; intros.
  case (Rcase_abs (x0 - x)); intro; apply impl_PI.
...
Proof.
  ...
  case (Rcase_abs x0); intro; apply impl_PI.
  unfold sqrt in |- *; case (Rcase_abs x0); intro; apply impl_PI.
