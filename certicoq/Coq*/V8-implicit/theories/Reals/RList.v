...
Proof.
  ...
  unfold Rmax in |- *; case (Rle_dec r (MaxRlist (cons r0 l))); intro; apply impl_PI.
...
Proof.
  ...
  unfold Rmin in |- *; case (Rle_dec r (MinRlist (cons r0 l))); intro; apply impl_PI.
...
Proof.
  ...
  elim H; intros; elim H0; intros; elim (zerop x0); intro; apply impl_PI.
...
Proof.
  ...
  intros; elim (zerop i); intro; apply impl_PI.
...
Proof.
  ...
  simpl in |- *; unfold ordered_Rlist in |- *; intros; simpl in H0;
    elim (lt_n_O _ H0).
  simpl in |- *; case (Rle_dec r a); intro; apply impl_PI.
