#ifndef CERTICOQ_TESTS_TESTS_LAZY_FACTORIAL_OPT5_C
#define CERTICOQ_TESTS_TESTS_LAZY_FACTORIAL_OPT5_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Tests.tests.lazy_factorial_opt5.h"
...
value body(struct thread_info *$tinfo)
{
  ...
  register value $CertiCoqdTestsdtestsdlazy_factorial_743;
  register value *$alloc;
  register value *$limit;
  register value *$args;
  $alloc = (*$tinfo).alloc;
  ...
  *(root + 0LL) = $y_736;
  ...
  (*$tinfo).limit = $limit;
  /*skip*/;
  $CertiCoqdTestsdtestsdlazy_factorial_743 =
  ...
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  return $CertiCoqdTestsdtestsdlazy_factorial_743;
}


#endif /* CERTICOQ_TESTS_TESTS_LAZY_FACTORIAL_OPT5_C */
