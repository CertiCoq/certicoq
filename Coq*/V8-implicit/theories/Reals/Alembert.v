...
Proof.
  ...
  red in |- *; intro; rewrite H1 in r; elim (Rlt_irrefl _ (impl_PI r)).
  apply AlembertC3_step2; apply impl_PI; assumption.
  cut (x <> 0).
  intro; apply AlembertC3_step1; assumption.
  red in |- *; intro; rewrite H1 in r; elim (Rlt_irrefl _ (impl_PI r)).
Qed.
...
Proof.
  ...
  apply H.
  symmetry  in |- *; apply tech2; apply impl_PI; assumption.
...
Lemma Alembert_C6 :
  ...
  elim s; intro.
  eapply Alembert_C5 with (k * Rabs x); apply impl_PI.
  split.
