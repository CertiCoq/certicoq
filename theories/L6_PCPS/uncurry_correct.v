...
Section uncurry_correct.
  ...
  (* Obligations generated by uncurry_step_correct_fundefs_curried *)
  Variables
    (Hpost_refl_constr : post_constr_compat Post Post)
    (Hpost_refl_proj : post_proj_compat Post Post)
    (Hpost_refl_fun : post_fun_compat Post Post)
  ...
  Hint Resolve bind_total : TotalDB.
  ...
  Require Import Lia. (* TODO move to top *)
      ...
      + (* Fcons *)
        ...
        * eapply bind_triple; [apply pre_post_copy; eapply pre_strenghtening; [|use_IH IHn] |].
        ...
        destruct (eq_var k k &&
                  ...
                  negb getb) eqn:Hpred.
        + eapply bind_triple'.
          rewrite pre_post_copy. apply get_names_lst_triple.
