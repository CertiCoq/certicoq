...
(*i $Id: hiddentac.mli 9952 2007-07-06 15:31:37Z letouzey $ i*)
...
val h_cut             : impl -> constr -> tactic 
val h_generalize      : impl list -> constr list -> tactic 
val h_generalize_dep  : impl -> constr -> tactic 
val h_let_tac         : name -> impl -> constr -> Tacticals.clause -> tactic
...
val h_lapply          : impl -> constr -> tactic
