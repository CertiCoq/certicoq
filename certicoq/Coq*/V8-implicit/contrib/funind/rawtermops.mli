...
val mkRApp  : rawconstr*rawconstr list*Term.impl list -> rawconstr
val mkRLambda : Names.name*Term.impl*rawconstr*rawconstr -> rawconstr
val mkRProd : Names.name*Term.impl*rawconstr*rawconstr -> rawconstr
val mkRLetIn : Names.name*Term.impl*rawconstr*rawconstr -> rawconstr
...
*)
val raw_decompose_prod :
  rawconstr -> (Names.name*Term.impl*rawconstr) list * rawconstr
val raw_decompose_prod_or_letin : 
  rawconstr ->
    (Names.name*Term.impl*rawconstr option*rawconstr option) list * rawconstr
val raw_decompose_prod_n :
  int -> rawconstr -> (Names.name*Term.impl*rawconstr) list * rawconstr
val raw_decompose_prod_or_letin_n : int -> rawconstr -> 
  (Names.name*Term.impl*rawconstr option*rawconstr option) list * rawconstr
val raw_compose_prod :
  rawconstr -> (Names.name*Term.impl*rawconstr) list  ->  rawconstr 
val raw_compose_prod_or_letin: rawconstr -> 
  (Names.name*Term.impl*rawconstr option*rawconstr option) list  ->  rawconstr
val raw_decompose_app :
  rawconstr -> rawconstr*rawconstr list*Term.impl list
