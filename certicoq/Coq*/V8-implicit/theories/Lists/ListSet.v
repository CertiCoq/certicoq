...
Section first_definitions.
  ...
  Proof.
    ...
    left;rewrite eq; simpl in |- *; auto with datatypes.
    elim Ha0.
    auto with datatypes.
  ...
  Proof.
    ...
    assumption.
    destruct (Aeq_dec a a0); apply impl_PI; auto with datatypes.
  Qed.
  ...
  Proof.
    ...
    discriminate.
    intros a0 l; destruct (Aeq_dec a a0); apply impl_PI; auto with datatypes.
  Qed.
  ...
  Proof.
    simple induction x; simpl in |- *.
    tauto.
    intros a0 l; destruct (Aeq_dec a a0); apply impl_PI.
  ...
  Proof.
    ...
    intros a0 l H Hab.
    elim (Aeq_dec b a0);
     [ rewrite Hab; intro Hba0; rewrite (impl_PI Hba0); simpl in |- *;
        auto with datatypes
     | auto with datatypes ].
  Qed.
  ...
  Proof.
    ...
    simpl in |- *; do 3 intro.
    destruct (Aeq_dec b a0); apply impl_PI.
    simpl in |- *; tauto.
