#ifndef CERTICOQ_TESTS_TESTS_DEMO1_OPT2_C
#define CERTICOQ_TESTS_TESTS_DEMO1_OPT2_C
#include <gc_stack.h>
#include <prim_string.h>
#include <prim_floats.h>
#include <prim_int63.h>
#include <coq_c_ffi.h>
#include "CertiCoq.Tests.tests.demo1_opt2.h"
...
unsigned long long const body_info_924[2] = { 1000LL, 0LL, };

unsigned long long const repeat_uncurried_known_info_923[4] = { 0LL, 2LL,
  0LL, 1LL, };

unsigned long long const app_uncurried_known_info_922[4] = { 0LL, 2LL, 0LL,
  1LL, };

value app_uncurried_known_102(struct thread_info *$tinfo, value $m_109, value $l_110)
{
  struct stack_frame frame;
  value root[2];
  register value $a_111;
  register value $l1_112;
  ...
  frame.prev = (*$tinfo).fp;
  if (($l_110 & 1) == 0) {
    switch (*((value *) $l_110 + -1LL) & 255LL) {
      default:
        $a_111 = *((value *) $l_110 + 0LL);
        $l1_112 = *((value *) $l_110 + 1LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 0LL) = $a_111;
...
value repeat_uncurried_known_101(struct thread_info *$tinfo, value $n_103, value $x_104)
{
  struct stack_frame frame;
  value root[2];
  register value $y_105;
  register value $k_106;
  ...
  frame.prev = (*$tinfo).fp;
  if (($n_103 & 1) == 0) {
    switch (*((value *) $n_103 + -1LL) & 255LL) {
      default:
        $k_106 = *((value *) $n_103 + 0LL);
        $args = (*$tinfo).args;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        *(root + 0LL) = $x_104;
        ...
        $x_104 = *(root + 0LL);
        (*$tinfo).fp = frame.prev;
        $y_108 = (value) ($alloc + 1LL);
        $alloc = $alloc + 3LL;
        *((value *) $y_108 + -1LL) = 2048LL;
        *((value *) $y_108 + 0LL) = $x_104;
        *((value *) $y_108 + 1LL) = $y_107;
        (*$tinfo).alloc = $alloc;
        (*$tinfo).limit = $limit;
        return $y_108;
        break;
...
value body(struct thread_info *$tinfo)
{
  ...
  register value $CertiCoqdTestsdtestsddemo1_921;
  register value *$alloc;
  register value *$limit;
  register value *$args;
  $alloc = (*$tinfo).alloc;
  ...
  *(root + 0LL) = $y_617;
  ...
  (*$tinfo).limit = $limit;
  /*skip*/;
  $CertiCoqdTestsdtestsddemo1_921 =
    ((value (*)(struct thread_info *, value, value)) app_uncurried_known_102)
    ($tinfo, $y_920, $y_617);
  $alloc = (*$tinfo).alloc;
  $limit = (*$tinfo).limit;
  ...
  (*$tinfo).alloc = $alloc;
  (*$tinfo).limit = $limit;
  return $CertiCoqdTestsdtestsddemo1_921;
}


#endif /* CERTICOQ_TESTS_TESTS_DEMO1_OPT2_C */
