...
val instance_from_named_context : named_context -> constr array * impl array

val imps_from_named_context : named_context -> impl list
val set_impl_named_context : impl -> named_context -> named_context
val is_expl_named : named_context -> identifier -> bool
...
val imps_from_rel_context : rel_context -> impl list
val set_impl_rel_context : impl -> rel_context -> rel_context
val is_expl_rel : rel_context -> int -> bool
