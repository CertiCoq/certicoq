...
val make_ind_family : inductive * constr list *  impl list -> inductive_family
val dest_ind_family :
  inductive_family -> inductive * constr list * impl list
...
val make_ind_type :
  inductive_family * constr list * impl list -> inductive_type
val dest_ind_type :
  inductive_type -> inductive_family * constr list * impl list
...
val get_arity        :
  env -> inductive_family -> rel_context * sorts_family
...
val extract_mrectype : constr -> inductive * constr list * impl list
val find_mrectype    :
  env -> evar_map -> constr -> inductive * constr list * impl list
...
val type_case_branches_with_names :
  env -> inductive * constr list * impl list -> unsafe_judgment -> constr ->
    types array * types
