...
Section Properties.
  ...
  Section Clos_Refl_Trans.
    ...
    Proof.
      ...
      exact (fun x => rt_refl A R [x]).
      
      exact (fun x => rt_trans A R [x]).
    Qed.
    ...
    Proof.
      ...
      generalize H H0.
      clear H H0.
      elim H1 using clos_refl_trans_ind'; intros; auto with sets.
  ...
  Section Clos_Refl_Sym_Trans.
    ...
    Proof.
      red in |- *.
      induction 1 using clos_refl_trans_ind'; auto with sets.
