...
Proof.
  ...
  intros q r g e.
  apply divex with (S q) r; apply impl_PI;
    simpl in |- *; auto with arith.
  elim plus_assoc.
  elim e; auto with arith.
  apply impl_PI; auto with arith.
  intros gtbn.
  apply divex with 0 n;
    apply impl_PI; simpl in |- *; auto with arith.
Qed.
...
Proof.
  ...
  apply impl_PI; auto with arith.
  intros gtbn.
  exists 0; exists n; apply impl_PI; simpl in |- *; auto with arith.
Qed.
...
Proof.
  ...
  apply impl_PI; auto with arith.
  intros gtbn.
  exists n; exists 0; apply impl_PI; simpl in |- *; auto with arith.
Qed.
