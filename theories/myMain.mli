 ...
 sig
  module Raw :
   sig
    ...
    val compare_more :
      clause -> (enumeration -> comparison) -> enumeration -> comparison
    ...
    val partition_aux :
      (elt -> bool) -> tree -> clause list -> clause list -> (clause list,
      clause list) prod
    ...
    | R_min_elt_2 of tree * Color.t * tree * clause * tree * Color.t * 
       tree * clause * tree * elt option * coq_R_min_elt

    type coq_R_max_elt =
    | R_max_elt_0 of tree
    | R_max_elt_1 of tree * Color.t * tree * clause * tree
    | R_max_elt_2 of tree * Color.t * tree * clause * tree * Color.t * 
       tree * clause * tree * elt option * coq_R_max_elt
    ...
    val rcase :
      (tree -> clause -> tree -> 'a1) -> (tree -> 'a1) -> tree -> 'a1

    val rrcase :
      (tree -> clause -> tree -> clause -> tree -> 'a1) -> (tree -> 'a1) ->
      tree -> 'a1
...
module Superposition :
 sig
  ...
  val ef_aux :
    pure_atom list -> var -> expr -> expr -> pure_atom list -> pure_atom list
  ...
  val main_terminate :
    positive -> clause list -> clause list -> (((superposition_result, clause
    list) prod, M.t) prod, M.t) prod
...
module HeapResolve :
 sig
  ...
  val unfolding3' :
    space_atom list -> space_atom list -> space_atom list -> space_atom list
    list
...
module VeriStar :
 sig
  ...
  val the_loop_terminate :
    positive -> space_atom list -> clause -> M.t -> clause -> veristar_result
